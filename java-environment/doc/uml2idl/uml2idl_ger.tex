...
\date{23. Februar 2004 \\~\\ \tiny{$Revision$ $Date$ $Author$}}
...
\begin{figure}[!h]
\centerline{\includegraphics[width=0.8 \linewidth]{problem1.eps}}
\caption{zyklische Abh{\"a}ngigkeit}
\label{fig:problem1}
\end{figure}
\begin{figure}[!h]
\centerline{\includegraphics[width=0.8 \linewidth]{noProblem.eps}}
...
\newpage
\textbf{Beispiel:}\\
\centerline{\includegraphics[width=0.6 \linewidth]{ocl1.eps}}\\
\textbf{IDL:}
\begin{verbatim}
module ITI {
    interface Math {
