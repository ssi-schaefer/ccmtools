 ...
 */
public class DtdComma extends DtdContent
{
     ...
     */
	public DtdComma( DtdContent expr1, DtdContent expr2 )
	{
        super();
        parameter1_ = expr1;
        parameter2_ = expr2;
    ...
    {
        return new DtdComma(parameter1_, parameter2_);
    }


    protected String makeText( short priority )
    {
        if( priority>PRIORITY_COMMA )
        {
            return "("+parameter1_.text(PRIORITY_COMMA)+","+parameter2_.text(PRIORITY_COMMA)+")";
        }
        return parameter1_.text(PRIORITY_COMMA)+","+parameter2_.text(PRIORITY_COMMA);
    }
