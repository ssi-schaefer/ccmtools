...
/**
 * AliasType XMI-object
 *
 * @author Robert Lechner (robert.lechner@salomon.at)
 * @version $Date$
 */
class AliasTypeXmi extends mof_xmi_parser.model.MAliasType implements Worker
{
    AliasTypeXmi( org.xml.sax.Attributes attrs )
    {
        super(attrs);
    }

    private AliasTypeImp implementation_;
    ...
    {
        parent_ = parent;
        implementation_ = new AliasTypeImp(this, parent==null ? null : parent.mof());
        ...
        while( it.hasNext() )
        {
            ...
            else if( obj instanceof MNamespace_contents )
            {
                ...
                while( it2.hasNext() )
                {
                    ...
                    {
                        System.err.println("AliasTypeXmi.register - it2: unknown child : "+
                                            o2.getClass().getName());
                    }
                }
            }
            ...
            {
                System.err.println("AliasTypeXmi.register - main: unknown child : "+obj.getClass().getName());
            }
        }
    }
    ...
    public void process( Model model )
    {
        ...
        if( xmi_idref_!=null )
        {
            ...
            w.process(model);
            implementation_ = (AliasTypeImp)w.mof();
        }
        processed_ = true;
        Iterator it = content().iterator();
        while( it.hasNext() )
