 ...
 * @version $Date$
 */
class CollectionTypeImp extends mof_xmi_parser.model.MCollectionType implements MofCollectionType, Worker
{
    CollectionTypeImp( org.xml.sax.Attributes attrs )
    {
        super(attrs);
    }
