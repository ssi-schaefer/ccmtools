...
/**
 * StructureField XMI-object
 *
 * @author Robert Lechner (robert.lechner@salomon.at)
 * @version $Date$
 */
class StructureFieldXmi extends mof_xmi_parser.model.MStructureField implements Worker
{
    StructureFieldXmi( org.xml.sax.Attributes attrs )
    {
        super(attrs);
    }

    private StructureFieldImp implementation_;
    ...
    {
        parent_ = parent;
        implementation_ = new StructureFieldImp(this, parent==null ? null : parent.mof());
        ...
        while( it.hasNext() )
        {
            ...
            {
                System.err.println("StructureFieldXmi.register - main: unknown child : "+obj.getClass().getName());
            }
        }
    }
    ...
    public void process( Model model )
    {
        ...
        if( xmi_idref_!=null )
        {
            ...
            w.process(model);
            implementation_ = (StructureFieldImp)w.mof();
        }
        processed_ = true;
        Iterator it = content().iterator();
        while( it.hasNext() )
