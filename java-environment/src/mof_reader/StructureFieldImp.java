 ...
 * @version $Date$
 */
class StructureFieldImp extends mof_xmi_parser.model.MStructureField implements MofStructureField, Worker
{
    StructureFieldImp( org.xml.sax.Attributes attrs )
    {
        super(attrs);
    }
