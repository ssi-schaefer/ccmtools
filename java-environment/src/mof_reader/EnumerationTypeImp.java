 ...
 * @version $Date$
 */
class EnumerationTypeImp extends mof_xmi_parser.model.MEnumerationType implements MofEnumerationType, Worker
{
    EnumerationTypeImp( org.xml.sax.Attributes attrs )
    {
        super(attrs);
    }
