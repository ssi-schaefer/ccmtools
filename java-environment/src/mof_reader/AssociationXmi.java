...
/**
 * Association XMI-object
 *
 * @author Robert Lechner (robert.lechner@salomon.at)
 * @version $Date$
 */
class AssociationXmi extends mof_xmi_parser.model.MAssociation implements Worker
{
    AssociationXmi( org.xml.sax.Attributes attrs )
    {
        super(attrs);
    }

    private AssociationImp implementation_;
    ...
    {
        parent_ = parent;
        implementation_ = new AssociationImp(this, parent==null ? null : parent.mof());
        ...
        while( it.hasNext() )
        {
            ...
            else if( obj instanceof MNamespace_contents )
            {
                ...
                while( it2.hasNext() )
                {
                    ...
                    {
                        System.err.println("AssociationXmi.register - it2: unknown child : "+
                                            o2.getClass().getName());
                    }
                }
            }
            ...
            {
                System.err.println("AssociationXmi.register - main: unknown child : "+obj.getClass().getName());
            }
        }
    }
    ...
    public void process( Model model )
    {
        ...
        if( xmi_idref_!=null )
        {
            ...
            w.process(model);
            implementation_ = (AssociationImp)w.mof();
        }
        processed_ = true;
        Iterator it = content().iterator();
        while( it.hasNext() )
