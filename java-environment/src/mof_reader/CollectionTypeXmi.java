...
/**
 * CollectionType XMI-object
 *
 * @author Robert Lechner (robert.lechner@salomon.at)
 * @version $Date$
 */
class CollectionTypeXmi extends mof_xmi_parser.model.MCollectionType implements Worker
{
    CollectionTypeXmi( org.xml.sax.Attributes attrs )
    {
        super(attrs);
    }

    private CollectionTypeImp implementation_;
    ...
    {
        parent_ = parent;
        implementation_ = new CollectionTypeImp(this, parent==null ? null : parent.mof());
        ...
        while( it.hasNext() )
        {
            ...
            {
                System.err.println("CollectionTypeXmi.register - main: unknown child : "+obj.getClass().getName());
            }
        }
    }
    ...
    public void process( Model model )
    {
        ...
        if( xmi_idref_!=null )
        {
            ...
            w.process(model);
            implementation_ = (CollectionTypeImp)w.mof();
        }
        processed_ = true;
        Iterator it = content().iterator();
        while( it.hasNext() )
