...
/**
 * Operation XMI-object
 *
 * @author Robert Lechner (robert.lechner@salomon.at)
 * @version $Date$
 */
class OperationXmi extends mof_xmi_parser.model.MOperation implements Worker
{
    OperationXmi( org.xml.sax.Attributes attrs )
    {
        super(attrs);
    }

    private OperationImp implementation_;
    ...
    {
        parent_ = parent;
        implementation_ = new OperationImp(this, parent==null ? null : parent.mof());
    ...
    public void process( Model model )
    {
        ...
        if( xmi_idref_!=null )
        {
            ...
            w.process(model);
            implementation_ = (OperationImp)w.mof();
        }
        processed_ = true;
        Iterator it = content().iterator();
        while( it.hasNext() )
