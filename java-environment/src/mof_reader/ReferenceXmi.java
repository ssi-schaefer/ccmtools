...
/**
 * Reference XMI-object
 *
 * @author Robert Lechner (robert.lechner@salomon.at)
 * @version $Date$
 */
class ReferenceXmi extends mof_xmi_parser.model.MReference implements Worker
{
    ReferenceXmi( org.xml.sax.Attributes attrs )
    {
        super(attrs);
    }

    private ReferenceImp implementation_;
    ...
    {
        parent_ = parent;
        implementation_ = new ReferenceImp(this, parent==null ? null : parent.mof());
    ...
    public void process( Model model )
    {
        ...
        if( xmi_idref_!=null )
        {
            ...
            w.process(model);
            implementation_ = (ReferenceImp)w.mof();
        }
        processed_ = true;
        Iterator it = content().iterator();
        while( it.hasNext() )
