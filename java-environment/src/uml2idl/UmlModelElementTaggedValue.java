...
/**
A container with elements of type {@link UmlTaggedValue}.
...
class UmlModelElementTaggedValue extends uml_parser.uml.MModelElement_taggedValue implements Worker
{
    ...
    UmlModelElementTaggedValue( Attributes attrs )
    {
        super(attrs);
        id_ = Main.makeId();
    }
	...
	public void collectWorkers( java.util.HashMap map )
	{
	    ...
	    for( int index=0; index<s; index++ )
	    {
	        ...
	        Main.logChild("UmlModelElementTaggedValue",obj);
	    }
	}
	...
	void addValues( java.util.HashMap map )
	{
	    ...
	    {
	        Object o = get(index);
	        if( o instanceof UmlTaggedValue )
	        {
	            ((UmlTaggedValue)o).addValue(map);
	        }
	    }
	}
