...
/**
A (simple) data type. <br>Children:
<ul>
...
*/
class UmlDataType extends ccmtools.uml_parser.uml.MDataType implements Worker
{
    private String id_;
    private Worker idlParent_;


    UmlDataType( Attributes attrs )
    {
        super(attrs);
        id_ = xmi_id_;
        if( id_==null )
