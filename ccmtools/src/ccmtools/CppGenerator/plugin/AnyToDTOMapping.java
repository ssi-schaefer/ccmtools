...
public class AnyToDTOMapping implements AnyMapping
{
    /** 
    ...
    public AnyToDTOMapping(CppLocalGenerator generator) 
    {
    ...
    public String getDebugCode(MAliasDef alias)
    {
        ...
        code.append("ccmDebug(const DTO& in, int indent = 0)\n");
        code.append("{\n");
