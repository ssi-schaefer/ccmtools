...
public class MConsumesDefImpl
    implements MConsumesDef
{
    private final static MDefinitionKind definitionKind =
        MDefinitionKind.DK_CONSUMES;
    ...
    {
	return "MConsumesDef: "+ identifier;
    }
    ...
    // association: direct role: emits[*] <-> opposite role: component[1]
    public MComponentDef getComponent()           {return Component_;}
    public void setComponent(MComponentDef __arg) {Component_ = __arg;}

    // association: direct role: [*] <-> opposite role: type[1]
    public MEventDef getType()                  {return Type_;}
    public void setType(MEventDef __arg)        {Type_ = __arg;}
