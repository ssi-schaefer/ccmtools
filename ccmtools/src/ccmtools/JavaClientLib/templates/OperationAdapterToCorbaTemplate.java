...
public class OperationAdapterToCorbaTemplate
{
  protected static String nl;
  public static synchronized OperationAdapterToCorbaTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    OperationAdapterToCorbaTemplate result = new OperationAdapterToCorbaTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_7 = ");" + NL + "        }" + NL + "        catch(Exception e)" + NL + "        {" + NL + "    \t    throw new CCMException(e.getMessage());" + NL + "        }" + NL + "    }";
