...
public class HomeImplicitDeclarationTemplate
{
  protected static String nl;
  public static synchronized HomeImplicitDeclarationTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    HomeImplicitDeclarationTemplate result = new HomeImplicitDeclarationTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_5 = "Implicit " + NL + "    extends ccm.local.Components.KeylessCCMHome" + NL + "{";
  protected final String TEXT_6 = NL + "    ";
  protected final String TEXT_7 = " create()" + NL + "        throws ccm.local.Components.CreateFailure;" + NL + "}";
