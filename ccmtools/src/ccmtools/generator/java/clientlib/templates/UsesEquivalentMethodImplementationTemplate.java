...
public class UsesEquivalentMethodImplementationTemplate
{
  protected static String nl;
  public static synchronized UsesEquivalentMethodImplementationTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    UsesEquivalentMethodImplementationTemplate result = new UsesEquivalentMethodImplementationTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_3 = " localObject)" + NL + "        throws ccm.local.Components.AlreadyConnected, ccm.local.Components.InvalidConnection" + NL + "    {" + NL + "    \t// Create CORBA objects and connect them to the remote component" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tif(";
  ...
  protected final String TEXT_6 = "AdapterFromCorba(localObject));" + NL + "\t\t\t\tremoteComponent.connect_";
  ...
  protected final String TEXT_10 = "()" + NL + "        throws ccm.local.Components.NoConnection" + NL + "    {" + NL + "   \t\ttry" + NL + "\t\t{" + NL + "\t\t\tif(";
  protected final String TEXT_11 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\tremoteComponent.disconnect_";
  ...
  protected final String TEXT_15 = "()" + NL + "    {" + NL + "        return ";
