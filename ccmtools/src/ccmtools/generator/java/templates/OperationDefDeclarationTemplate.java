...
public class OperationDefDeclarationTemplate
{
  protected static String nl;
  public static synchronized OperationDefDeclarationTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    OperationDefDeclarationTemplate result = new OperationDefDeclarationTemplate();
    nl = null;
    return result;
  }
