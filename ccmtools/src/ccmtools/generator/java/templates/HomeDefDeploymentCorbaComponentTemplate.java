...
public class HomeDefDeploymentCorbaComponentTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "" + NL + "import ccm.local.ServiceLocator;" + NL + "import ccm.local.Components.CCMException;" + NL + "import ccm.remote.CCMSessionContainer;" + NL + "" + NL + "import org.omg.PortableServer.POA;" + NL + "import org.omg.CosNaming.NamingContextExt;" + NL + "import org.omg.CosNaming.NamingContextExtHelper;" + NL;
  ...
  protected final String TEXT_13 = "Helper.narrow(container.getCorbaHome());" + NL + "        }" + NL + "        catch(Exception e)" + NL + "        {" + NL + "            e.printStackTrace();" + NL + "            throw new CCMException(e.getMessage());" + NL + "        }" + NL + "    }" + NL + "    " + NL + "    // TODO: Move the following methods into a base class!!!!" + NL + "        " + NL + "    public static void deploy(String name)" + NL + "        throws CCMException" + NL + "    {" + NL + "        logger.fine(\"name = \" + name);" + NL + "        deploy();" + NL + "        container.registerCorbaHome(name);" + NL + "    }" + NL + "" + NL + "    public static String deployWithIor()" + NL + "        throws CCMException" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        deploy();" + NL + "        return container.getCorbaHomeIor();" + NL + "    }" + NL + "    " + NL + "    public static void undeploy(String name)" + NL + "        throws CCMException" + NL + "    {" + NL + "        logger.fine(\"name = \" + name);" + NL + "        container.unregisterCorbaHome(name);" + NL + "    }" + NL + "}";
