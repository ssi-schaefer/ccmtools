...
public class StructDefImplementationTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.io.Serializable;              " + NL + " " + NL + "public class ";
  protected final String TEXT_4 = " " + NL + "     implements Serializable" + NL + "{" + NL + "    private static final long serialVersionUID = ";
  protected final String TEXT_5 = "L;" + NL + "    ";
