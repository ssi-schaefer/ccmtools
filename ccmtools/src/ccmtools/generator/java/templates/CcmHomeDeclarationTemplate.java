...
public class CcmHomeDeclarationTemplate
{
  protected static String nl;
  public static synchronized CcmHomeDeclarationTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    CcmHomeDeclarationTemplate result = new CcmHomeDeclarationTemplate();
    nl = null;
    return result;
  }
