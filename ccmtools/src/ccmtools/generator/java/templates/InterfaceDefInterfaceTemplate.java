...
public class InterfaceDefInterfaceTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "                 " + NL + "import ccm.local.Components.*;" + NL + " " + NL + "/** " + NL + " * Java interface declaration (based on the corresponding IDL interface)." + NL + " */" + NL + "public interface ";
