...
public class ComponentDefAdapterLocalTemplate
{
  ...
  protected final String TEXT_9 = "_Context ctx;" + NL + "    private ccm.local.Components.Assembly assembly;" + NL + "" + NL + "    /** Facet adapter references */";
  ...
  protected final String TEXT_18 = " localInterface," + NL + "         ccm.local.Components.Assembly assembly)" + NL + "    {" + NL + "        logger.fine(\"localInterface = \" + localInterface + \", \" + assembly);" + NL + "        this.localInterface = localInterface;" + NL + "        this.assembly = assembly;" + NL + "    }" + NL + "\t" + NL + "\t" + NL + "    /* " + NL + "     * Supported interface methods " + NL + "     */" + NL + "" + NL + "    /** Supported interface attributes */";
  ...
  protected final String TEXT_28 = NL + "\t" + NL + "    /** CCMObject interface methods */" + NL + "\t" + NL + "    public void configuration_complete()" + NL + "        throws ccm.local.Components.InvalidConfiguration" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        ctx = new ";
  protected final String TEXT_29 = "_ContextImpl(this); " + NL + "        try" + NL + "        {" + NL + "            if(assembly != null) " + NL + "            { " + NL + "\t\t        assembly.configuration_complete(); " + NL + "\t        }" + NL + "            localInterface.set_session_context(ctx);" + NL + "            localInterface.ccm_activate();" + NL + "        }" + NL + "        catch (ccm.local.Components.CCMException e)" + NL + "        {" + NL + "            throw new ccm.local.Components.InvalidConfiguration();" + NL + "        }" + NL + "    }" + NL + "" + NL + "    public void remove()" + NL + "        throws ccm.local.Components.RemoveFailure" + NL + "    { " + NL + "        logger.fine(\"\");" + NL + "        try " + NL + "        {" + NL + "            localInterface.ccm_remove();" + NL + "            if(assembly != null) " + NL + "\t        { " + NL + "\t\t        assembly.tear_down(); " + NL + "\t \t        assembly = null;" + NL + "\t        }" + NL + "        }" + NL + "        catch(ccm.local.Components.CCMException e)" + NL + "        {" + NL + "            throw new ccm.local.Components.RemoveFailure();" + NL + "        }" + NL + "    }" + NL + "    " + NL + "    public ccm.local.Components.HomeExecutorBase get_ccm_home()" + NL + "    {" + NL + "        throw new RuntimeException(\"Not implemented!\");" + NL + "    }" + NL + "    " + NL + "    " + NL + "    /** Navigation interface methods */" + NL + "    " + NL + "    public Object provide_facet(String name)" + NL + "        throws ccm.local.Components.InvalidName" + NL + "    {" + NL + "        logger.fine(\"name = \" + name);" + NL + "        if(name == null)" + NL + "        {" + NL + "            throw new ccm.local.Components.InvalidName();" + NL + "        }";
  protected final String TEXT_30 = NL;
  protected final String TEXT_31 = "   " + NL + "        throw new ccm.local.Components.InvalidName();" + NL + "    }" + NL + "    " + NL + "    " + NL + "    /** Receptacle methods */" + NL + "    " + NL + "    public ccm.local.Components.Cookie connect(String name, Object obj)" + NL + "        throws ccm.local.Components.InvalidName, " + NL + "               ccm.local.Components.InvalidConnection," + NL + "               ccm.local.Components.AlreadyConnected, " + NL + "               ccm.local.Components.ExceededConnectionLimit" + NL + "    {" + NL + "        logger.fine(\"name = \" + name + \", obj = \" + obj);" + NL + "        if(name == null)" + NL + "        {" + NL + "            throw new ccm.local.Components.InvalidName();" + NL + "        }" + NL + "        if(obj == null)" + NL + "        {" + NL + "            throw new ccm.local.Components.InvalidConnection();" + NL + "        }    ";
  protected final String TEXT_32 = "     ";
  protected final String TEXT_33 = NL;
  protected final String TEXT_34 = "     " + NL + "        else" + NL + "        {" + NL + "            throw new ccm.local.Components.InvalidName();" + NL + "        }" + NL + "    }" + NL + "    " + NL + "    public void disconnect(String name, ccm.local.Components.Cookie ck)" + NL + "        throws ccm.local.Components.InvalidName, " + NL + "               ccm.local.Components.InvalidConnection," + NL + "               ccm.local.Components.CookieRequired, " + NL + "               ccm.local.Components.NoConnection" + NL + "    {" + NL + "        logger.fine(\"name = \" + name + \", ck = \" + ck );" + NL + "        if(name == null)" + NL + "        {" + NL + "            throw new ccm.local.Components.InvalidName();" + NL + "        }" + NL + "        if(ck == null)" + NL + "        {" + NL + "            throw new ccm.local.Components.CookieRequired();" + NL + "        } ";
