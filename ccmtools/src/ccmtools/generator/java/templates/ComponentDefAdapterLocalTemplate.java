...
public class ComponentDefAdapterLocalTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "" + NL + "import Components.AlreadyConnected;" + NL + "import Components.Assembly;" + NL + "import Components.CCMException;     " + NL + "import Components.CCMHome;" + NL + "import Components.Cookie;" + NL + "import Components.CookieImpl;" + NL + "import Components.CookieRequired;" + NL + "import Components.ExceededConnectionLimit;" + NL + "import Components.InvalidConfiguration;" + NL + "import Components.InvalidConnection;" + NL + "import Components.InvalidName;" + NL + "import Components.NoConnection;" + NL + "import Components.RemoveFailure;" + NL + "import ccmtools.local.ServiceLocator;" + NL;
