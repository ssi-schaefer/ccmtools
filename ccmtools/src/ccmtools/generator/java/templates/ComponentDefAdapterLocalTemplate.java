...
public class ComponentDefAdapterLocalTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "" + NL + "import Components.ccm.local.AlreadyConnected;" + NL + "import Components.ccm.local.Assembly;" + NL + "import Components.ccm.local.CCMException;     " + NL + "import Components.ccm.local.CCMHome;" + NL + "import Components.ccm.local.Cookie;" + NL + "import Components.ccm.local.CookieImpl;" + NL + "import Components.ccm.local.CookieRequired;" + NL + "import Components.ccm.local.ExceededConnectionLimit;" + NL + "import Components.ccm.local.InvalidConfiguration;" + NL + "import Components.ccm.local.InvalidConnection;" + NL + "import Components.ccm.local.InvalidName;" + NL + "import Components.ccm.local.NoConnection;" + NL + "import Components.ccm.local.RemoveFailure;" + NL + "import ccm.local.ServiceLocator;" + NL;
