...
public class ComponentDefAdapterLocalTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "" + NL + "import ccm.local.Components.AlreadyConnected;" + NL + "import ccm.local.Components.Assembly;" + NL + "import ccm.local.Components.Cookie;" + NL + "import ccm.local.Components.CookieRequired;" + NL + "import ccm.local.Components.ExceededConnectionLimit;" + NL + "import ccm.local.Components.CCMHome;" + NL + "import ccm.local.Components.InvalidConfiguration;" + NL + "import ccm.local.Components.InvalidConnection;" + NL + "import ccm.local.Components.InvalidName;" + NL + "import ccm.local.Components.NoConnection;" + NL + "import ccm.local.Components.RemoveFailure;" + NL + "import ccm.local.ServiceLocator;" + NL;
