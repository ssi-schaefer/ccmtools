...
public class HomeDefExplicitApplicationInterfaceTemplate
{
  protected static String nl;
  public static synchronized HomeDefExplicitApplicationInterfaceTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    HomeDefExplicitApplicationInterfaceTemplate result = new HomeDefExplicitApplicationInterfaceTemplate();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_4 = "Explicit " + NL + "    extends Components.ccm.local.HomeExecutorBase" + NL + "{" + NL + "}";
