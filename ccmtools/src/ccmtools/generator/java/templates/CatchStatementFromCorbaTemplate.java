...
public class CatchStatementFromCorbaTemplate
{
  protected static String nl;
  public static synchronized CatchStatementFromCorbaTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    CatchStatementFromCorbaTemplate result = new CatchStatementFromCorbaTemplate();
    nl = null;
    return result;
  }
