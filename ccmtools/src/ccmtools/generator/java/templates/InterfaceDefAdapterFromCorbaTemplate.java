...
public class InterfaceDefAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "                 " + NL + "import java.util.logging.Logger;" + NL + "import ccmtools.local.ServiceLocator;" + NL + "" + NL + "import org.omg.CORBA.BAD_OPERATION;" + NL;
