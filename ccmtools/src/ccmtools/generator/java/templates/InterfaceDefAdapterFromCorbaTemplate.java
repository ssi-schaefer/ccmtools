...
public class InterfaceDefAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "                 " + NL + "import org.omg.CORBA.*;" + NL + "" + NL + "/**" + NL + " * Interface adapter from CORBA to Java." + NL + " */" + NL + "public class ";
  ...
  protected final String TEXT_8 = " receptacle)" + NL + "    {" + NL + "        this.localInterface = receptacle;" + NL + "    }    \t" + NL;
...
for(Iterator i=iface.getBaseInterfaces().iterator(); i.hasNext();)
{
    ...
    stringBuffer.append(attr.generateAttributeDefAdapterFromCorba());
...
for(Iterator i=iface.getBaseInterfaces().iterator(); i.hasNext();)
{
    ...
    stringBuffer.append(op.generateOperationDefAdapterFromCorba());
