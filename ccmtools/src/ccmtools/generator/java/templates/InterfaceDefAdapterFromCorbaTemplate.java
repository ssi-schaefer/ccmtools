...
public class InterfaceDefAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_7 = "POA" + NL + "{" + NL + "    private java.util.logging.Logger logger = ccmtools.local.ServiceLocator.instance().getLogger();" + NL + "    " + NL + "    /** Java reference to the local interface */" + NL + "    private ";
