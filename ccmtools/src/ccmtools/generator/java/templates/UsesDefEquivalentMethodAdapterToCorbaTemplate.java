...
public class UsesDefEquivalentMethodAdapterToCorbaTemplate
{
  ...
  protected final String TEXT_3 = " localObject)" + NL + "        throws Components.AlreadyConnected, Components.InvalidConnection" + NL + "    {" + NL + "        logger.fine(\"localInterface = \" + localObject);" + NL + "        // Create CORBA objects and connect them to the remote component" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tif(";
  ...
  protected final String TEXT_8 = "Helper.narrow(remoteObject));" + NL + "\t\t\t}" + NL + "\t\t\telse" + NL + "\t\t\t{" + NL + "\t\t\t\tthrow new Components.AlreadyConnected();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tcatch (org.omg.PortableServer.POAPackage.ServantNotActive e)" + NL + "\t\t{" + NL + "\t\t\tthrow new Components.InvalidConnection();" + NL + "\t\t}" + NL + "\t\tcatch (org.omg.PortableServer.POAPackage.WrongPolicy e)" + NL + "\t\t{" + NL + "\t\t\tthrow new Components.InvalidConnection();" + NL + "\t\t}" + NL + "\t\tcatch (ccmtools.corba.Components.AlreadyConnected e)" + NL + "\t\t{" + NL + "\t\t\tthrow new Components.AlreadyConnected();" + NL + "\t\t}" + NL + "\t\tcatch (ccmtools.corba.Components.InvalidConnection e)" + NL + "\t\t{" + NL + "\t\t\tthrow new Components.InvalidConnection();" + NL + "\t\t}" + NL + "    }" + NL + "" + NL + "    public ";
  protected final String TEXT_9 = " disconnect_";
  protected final String TEXT_10 = "()" + NL + "        throws Components.NoConnection" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "   \t\ttry" + NL + "\t\t{" + NL + "\t\t\tif(";
  protected final String TEXT_11 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\tremoteInterface.disconnect_";
  protected final String TEXT_12 = "();" + NL + "\t\t\t\treturn ";
  protected final String TEXT_13 = ";" + NL + "\t\t\t}" + NL + "\t\t\telse " + NL + "\t\t\t{" + NL + "\t\t\t\tthrow new Components.NoConnection();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tcatch (java.lang.Exception e)" + NL + "\t\t{" + NL + "\t\t\tthrow new Components.NoConnection();" + NL + "\t\t}" + NL + "    " + NL + "    }" + NL + "       " + NL + "    public ";
