...
public class UsesDefEquivalentMethodAdapterToCorbaTemplate
{
  ...
  protected final String TEXT_8 = "Helper.narrow(remoteObject));" + NL + "\t\t\t}" + NL + "\t\t\telse" + NL + "\t\t\t{" + NL + "\t\t\t\tthrow new AlreadyConnected();" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tcatch (org.omg.PortableServer.POAPackage.ServantNotActive e)" + NL + "\t\t{" + NL + "\t\t\tthrow new InvalidConnection();" + NL + "\t\t}" + NL + "\t\tcatch (org.omg.PortableServer.POAPackage.WrongPolicy e)" + NL + "\t\t{" + NL + "\t\t\tthrow new InvalidConnection();" + NL + "\t\t}" + NL + "\t\tcatch (Components.AlreadyConnected e)" + NL + "\t\t{" + NL + "\t\t\tthrow new AlreadyConnected();" + NL + "\t\t}" + NL + "\t\tcatch (Components.InvalidConnection e)" + NL + "\t\t{" + NL + "\t\t\tthrow new InvalidConnection();" + NL + "\t\t}" + NL + "    }" + NL + "" + NL + "    public ";
