...
public class ComponentDefContextClassTemplate
{
  ...
  protected final String TEXT_5 = "_Context" + NL + "{" + NL + "    private java.util.logging.Logger logger = ccmtools.local.ServiceLocator.instance().getLogger();" + NL + "" + NL + "    private ";
  ...
  protected final String TEXT_10 = "      " + NL + "    " + NL + "    " + NL + "    /** CCMContext methods */" + NL + "\t    " + NL + "    public Components.HomeExecutorBase get_CCM_home()" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        throw new RuntimeException(\"Not implemented!\");" + NL + "    }" + NL + "" + NL + "" + NL + "    /** SessionContext methods */" + NL + "    " + NL + "    public Object get_CCM_object()" + NL + "        throws Components.IllegalState" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        throw new RuntimeException(\"Not implemented!\");" + NL + "    }" + NL + "}";
