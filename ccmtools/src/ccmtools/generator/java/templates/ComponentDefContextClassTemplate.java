...
public class ComponentDefContextClassTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "            " + NL + "import java.util.logging.Logger;" + NL + "import ccm.local.ServiceLocator;" + NL + "                     " + NL + "public class ";
  ...
  protected final String TEXT_10 = "      " + NL + "    " + NL + "    " + NL + "    /** CCMContext methods */" + NL + "\t    " + NL + "    public ccm.local.Components.HomeExecutorBase get_CCM_home()" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        throw new RuntimeException(\"Not implemented!\");" + NL + "    }" + NL + "" + NL + "" + NL + "    /** SessionContext methods */" + NL + "    " + NL + "    public Object get_CCM_object()" + NL + "        throws ccm.local.Components.IllegalState" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        throw new RuntimeException(\"Not implemented!\");" + NL + "    }" + NL + "}";
