...
public class ComponentDefContextClassTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "            " + NL + "import Components.HomeExecutorBase;" + NL + "import Components.IllegalState;       " + NL + "import Components.NoConnection;" + NL + "            " + NL + "import java.util.logging.Logger;" + NL + "import ccmtools.local.ServiceLocator;" + NL + "                     " + NL + "public class ";
