...
public class ComponentDefAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_8 = " localComponent;" + NL + "        " + NL + "    /** CORBA facet references */";
  ...
  protected final String TEXT_17 = " localComponent)" + NL + "    {    " + NL + "        logger.fine(\"localComponent = \" + localComponent);" + NL + "        this.container = container;" + NL + "        this.localComponent = localComponent;";
  ...
  protected final String TEXT_27 = NL + "    " + NL + "    /** " + NL + "     * The following operations are defined in the Components::CCMObject" + NL + "     * interface." + NL + "     */" + NL + "    " + NL + "    public Components.CCMHome get_ccm_home()" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        return container.getCorbaHome();" + NL + "    }" + NL + "" + NL + "    public void configuration_complete()" + NL + "        throws Components.InvalidConfiguration" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        try" + NL + "        {" + NL + "            localComponent.configuration_complete();" + NL + "        }" + NL + "        catch(ccm.local.Components.InvalidConfiguration e)" + NL + "        {" + NL + "            e.printStackTrace();" + NL + "            throw new Components.InvalidConfiguration();" + NL + "        }" + NL + "    }" + NL + "" + NL + "    public void remove()" + NL + "        throws Components.RemoveFailure" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        //TODO:" + NL + "    }" + NL + "    " + NL + "    " + NL + "    /** " + NL + "     * The following operations are defined in the Components::Navigation" + NL + "     * interface." + NL + "     */" + NL + "" + NL + "    public org.omg.CORBA.Object provide_facet(String name) " + NL + "        throws Components.InvalidName" + NL + "    {" + NL + "        logger.fine(\"\");\t" + NL + "        if(name == null)" + NL + "        {" + NL + "            throw new Components.InvalidName();" + NL + "        }";
  protected final String TEXT_28 = "        ";
  protected final String TEXT_29 = NL;
  protected final String TEXT_30 = NL + "        else" + NL + "        {" + NL + "            throw new Components.InvalidName();" + NL + "        }" + NL + "    }" + NL + "" + NL + "" + NL + "    /** " + NL + "     * The following operations are defined in the Components::Receptacles" + NL + "     * interface." + NL + "     */" + NL + "     " + NL + "    public Components.Cookie connect(String name, org.omg.CORBA.Object obj) " + NL + "        throws Components.InvalidName, " + NL + "        Components.InvalidConnection, " + NL + "        Components.AlreadyConnected, " + NL + "        Components.ExceededConnectionLimit" + NL + "    {" + NL + "        logger.fine(\"name = \" + name + \", obj = \" + obj);" + NL + "        if(name == null) " + NL + "        {" + NL + "            throw new Components.InvalidName(\"connection name is null!\");" + NL + "        }";
  protected final String TEXT_31 = "        ";
  protected final String TEXT_32 = NL;
  protected final String TEXT_33 = NL + "        else" + NL + "        {" + NL + "            throw new Components.InvalidName(name);" + NL + "        }\t" + NL + "    }" + NL + "" + NL + "    public void disconnect(String name, Components.Cookie ck) " + NL + "        throws Components.InvalidName, " + NL + "        Components.InvalidConnection, " + NL + "        Components.CookieRequired, " + NL + "        Components.NoConnection" + NL + "    {" + NL + "        logger.fine(\"name = \" + name + \", ck = \" + ck);" + NL + "        if(name == null)" + NL + "        {" + NL + "            throw new Components.InvalidName(\"connection name is null!\");" + NL + "        }";
  protected final String TEXT_34 = "        ";
  protected final String TEXT_35 = NL;
  protected final String TEXT_36 = NL + "        else" + NL + "        {" + NL + "            throw new Components.InvalidName(name);" + NL + "        }\t" + NL + "    }" + NL + "}";
