...
public class ComponentDefAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "import java.util.Iterator;" + NL + "import java.util.Map;" + NL + "import java.util.HashMap;" + NL + "" + NL + "import Components.AlreadyConnected;" + NL + "import Components.Cookie;" + NL + "import Components.CookieImpl;" + NL + "import Components.CCMException;   " + NL + "import Components.ExceededConnectionLimit;" + NL + "import Components.InvalidConfiguration;" + NL + "import Components.InvalidConnection;" + NL + "import Components.NoConnection;" + NL + "import Components.RemoveFailure;" + NL + "" + NL + "import ccmtools.local.ServiceLocator;" + NL + "import ccmtools.remote.CCMSessionContainer;" + NL + "" + NL + "import org.omg.PortableServer.Servant;" + NL + "import org.omg.CORBA.BAD_OPERATION;" + NL + "          ";
  ...
  protected final String TEXT_33 = NL + "    " + NL + "    /** " + NL + "     * The following operations are defined in the Components::CCMObject" + NL + "     * interface." + NL + "     */" + NL + "    " + NL + "    public ccmtools.corba.Components.CCMHome get_ccm_home()" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        return container.getCorbaHome();" + NL + "    }" + NL + "" + NL + "    public void configuration_complete()" + NL + "        throws ccmtools.corba.Components.InvalidConfiguration" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        try" + NL + "        {" + NL + "            localInterface.configuration_complete();" + NL + "        }" + NL + "        catch(InvalidConfiguration e)" + NL + "        {" + NL + "            e.printStackTrace();" + NL + "            throw new ccmtools.corba.Components.InvalidConfiguration();" + NL + "        }" + NL + "    }" + NL + "" + NL + "    public void remove()" + NL + "        throws ccmtools.corba.Components.RemoveFailure" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        try" + NL + "        {" + NL + "            if(localInterface == null)" + NL + "            {" + NL + "                throw new ccmtools.corba.Components.RemoveFailure(" + NL + "                    \"Can't remove component because its local reference is null!\");" + NL + "            }" + NL + "            else" + NL + "            {" + NL + "                localInterface.remove();" + NL + "            }" + NL + "        }" + NL + "        catch(RemoveFailure e)" + NL + "        {" + NL + "        \t    e.printStackTrace();" + NL + "            throw new ccmtools.corba.Components.RemoveFailure(e.getMessage());" + NL + "        }" + NL + "    }" + NL + "    " + NL + "    " + NL + "    /** " + NL + "     * The following operations are defined in the Components::Navigation" + NL + "     * interface." + NL + "     */" + NL + "" + NL + "    public org.omg.CORBA.Object provide_facet(String name) " + NL + "        throws ccmtools.corba.Components.InvalidName" + NL + "    {" + NL + "        logger.fine(\"\");\t" + NL + "        if(name == null)" + NL + "        {" + NL + "            throw new ccmtools.corba.Components.InvalidName();" + NL + "        }";
  protected final String TEXT_34 = "        ";
  protected final String TEXT_35 = NL;
  protected final String TEXT_36 = NL + "        else" + NL + "        {" + NL + "            throw new ccmtools.corba.Components.InvalidName();" + NL + "        }" + NL + "    }" + NL + "" + NL + "" + NL + "    /** " + NL + "     * The following operations are defined in the Components::Receptacles" + NL + "     * interface." + NL + "     */" + NL + "     " + NL + "    public ccmtools.corba.Components.Cookie connect(String name, org.omg.CORBA.Object obj) " + NL + "        throws ccmtools.corba.Components.InvalidName, " + NL + "        ccmtools.corba.Components.InvalidConnection, " + NL + "        ccmtools.corba.Components.AlreadyConnected, " + NL + "        ccmtools.corba.Components.ExceededConnectionLimit" + NL + "    {" + NL + "        logger.fine(\"name = \" + name + \", obj = \" + obj);" + NL + "        if(name == null) " + NL + "        {" + NL + "            throw new ccmtools.corba.Components.InvalidName(\"connection name is null!\");" + NL + "        }";
  protected final String TEXT_37 = "        ";
  protected final String TEXT_38 = NL;
  protected final String TEXT_39 = NL + "        else" + NL + "        {" + NL + "            throw new ccmtools.corba.Components.InvalidName(name);" + NL + "        }\t" + NL + "    }" + NL + "" + NL + "    public void disconnect(String name, ccmtools.corba.Components.Cookie ck) " + NL + "        throws ccmtools.corba.Components.InvalidName, " + NL + "        ccmtools.corba.Components.InvalidConnection, " + NL + "        ccmtools.corba.Components.CookieRequired, " + NL + "        ccmtools.corba.Components.NoConnection" + NL + "    {" + NL + "        logger.fine(\"name = \" + name + \", ck = \" + ck);" + NL + "        if(name == null)" + NL + "        {" + NL + "            throw new ccmtools.corba.Components.InvalidName(\"connection name is null!\");" + NL + "        }";
  protected final String TEXT_40 = "        ";
  protected final String TEXT_41 = NL;
  protected final String TEXT_42 = NL + "        else" + NL + "        {" + NL + "            throw new ccmtools.corba.Components.InvalidName(name);" + NL + "        }\t" + NL + "    }" + NL + "}";
