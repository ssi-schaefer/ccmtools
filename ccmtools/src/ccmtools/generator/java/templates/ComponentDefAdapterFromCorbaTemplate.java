...
public class ComponentDefAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "import java.util.Iterator;" + NL + "import java.util.Map;" + NL + "import java.util.HashMap;" + NL + "" + NL + "import Components.ccm.local.AlreadyConnected;" + NL + "import Components.ccm.local.Cookie;" + NL + "import Components.ccm.local.CookieImpl;" + NL + "import Components.ccm.local.CCMException;   " + NL + "import Components.ccm.local.ExceededConnectionLimit;" + NL + "import Components.ccm.local.InvalidConfiguration;" + NL + "import Components.ccm.local.InvalidConnection;" + NL + "import Components.ccm.local.NoConnection;" + NL + "" + NL + "import ccm.local.ServiceLocator;" + NL + "import ccm.remote.CCMSessionContainer;" + NL + "" + NL + "import org.omg.PortableServer.Servant;" + NL + "import org.omg.CORBA.BAD_OPERATION;" + NL + "          ";
