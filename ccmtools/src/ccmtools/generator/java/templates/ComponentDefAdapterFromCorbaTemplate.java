...
public class ComponentDefAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.Iterator;" + NL + "import java.util.Map;" + NL + "import java.util.HashMap;" + NL;
  protected final String TEXT_4 = NL;
  protected final String TEXT_5 = NL + NL + "public class ";
  protected final String TEXT_6 = "AdapterFromCorba " + NL + "     extends ";
  protected final String TEXT_7 = "POA" + NL + "{" + NL + "    /** Default logger instance */" + NL + "    private java.util.logging.Logger logger = ccmtools.local.ServiceLocator.instance().getLogger();" + NL + "  " + NL + "    /** CCM session container instance */  " + NL + "    private ccmtools.remote.CCMSessionContainer container;" + NL + "" + NL + "    /** Local component instance */" + NL + "    private ";
  ...
  protected final String TEXT_15 = "AdapterFromCorba(ccmtools.remote.CCMSessionContainer container, ";
