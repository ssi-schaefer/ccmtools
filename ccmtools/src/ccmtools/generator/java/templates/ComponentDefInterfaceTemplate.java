...
public class ComponentDefInterfaceTemplate
{
  ...
  protected final String TEXT_4 = " " + NL + "    extends ccm.local.Components.CCMObject";
  protected final String TEXT_5 = NL + "{" + NL + "    /** Supported interface constants */" + NL + "    " + NL + "    " + NL + "    " + NL + "" + NL + "    /** Supported interface attributes */";
  protected final String TEXT_6 = NL;
  protected final String TEXT_7 = "    " + NL + "    " + NL + "    " + NL + "    /** Supported interface methods */";
  protected final String TEXT_8 = NL;
  protected final String TEXT_9 = "    " + NL + "" + NL + "" + NL + "    /** Attribute equivalent methods */";
  protected final String TEXT_10 = NL;
  protected final String TEXT_11 = "    " + NL + "" + NL + "    /** Facet equivalent methods */" + NL + "    ";
  protected final String TEXT_12 = NL;
  protected final String TEXT_13 = "    " + NL + "    " + NL + "    /** Receptacle equivalent methods */";
