...
public class InterfaceDefAdapterToCorbaTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "   " + NL + "import java.util.logging.Logger;" + NL + "import ccm.local.ServiceLocator;" + NL + "" + NL + "                 " + NL + "/**" + NL + " * Interface adapter from Java to CORBA." + NL + " */" + NL + "public class ";
  protected final String TEXT_4 = "AdapterToCorba" + NL + "    implements ";
  protected final String TEXT_5 = NL + "{" + NL + "    private Logger logger = ServiceLocator.instance().getLogger();" + NL + "    " + NL + "    /** Corba reference to the remote interface */" + NL + "    private ";
  protected final String TEXT_6 = " remoteInterface;" + NL + "\t" + NL + "    public ";
  protected final String TEXT_7 = "AdapterToCorba(";
  protected final String TEXT_8 = " facet)" + NL + "    {" + NL + "        logger.fine(\"remoteInterface = \" + facet);" + NL + "        this.remoteInterface = facet;" + NL + "    }" + NL;
