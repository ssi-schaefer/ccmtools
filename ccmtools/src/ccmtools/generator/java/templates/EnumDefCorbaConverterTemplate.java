...
public class EnumDefCorbaConverterTemplate
{
  ...
  protected final String TEXT_8 = " out;" + NL + "        switch(in)" + NL + "        {";
  protected final String TEXT_9 = NL;
  protected final String TEXT_10 = NL + "            default:" + NL + "                out = null;" + NL + "        }" + NL + "        return out;" + NL + "    }" + NL + "" + NL + "" + NL + "    /** Convert a CORBA type into a local Java type */" + NL + "    public static ";
  protected final String TEXT_11 = " convert(";
  protected final String TEXT_12 = " in)" + NL + "    {";
  protected final String TEXT_13 = NL + "        ";
  protected final String TEXT_14 = " out; " + NL + "        switch(in.value())" + NL + "        {";
  protected final String TEXT_15 = NL;
  protected final String TEXT_16 = NL + "            default:" + NL + "                out = null;" + NL + "        }" + NL + "        return out;" + NL + "    }" + NL + "};" + NL;
