...
public class ComponentDefAssemblyClassTemplate
{
  ...
  protected final String TEXT_38 = NL + NL + "\t\t\tccm_activate_ok = true; " + NL + "    \t} catch(Exception e) {" + NL + "    \t\tthrow new Components.CCMException(" + NL + "    \t\t\t\"assembly configuration failed: \"+e.getMessage()," + NL + "    \t\t\tComponents.CCMExceptionReason.CREATE_ERROR, e);" + NL + "    \t}" + NL + "    }" + NL + "" + NL + "    public void ccm_passivate() " + NL + "        throws Components.CCMException" + NL + "    {" + NL + "        // Who calls this method?" + NL + "    }" + NL + "" + NL + "    public void ccm_remove() " + NL + "        throws Components.CCMException" + NL + "    {" + NL + "    \ttry {";
