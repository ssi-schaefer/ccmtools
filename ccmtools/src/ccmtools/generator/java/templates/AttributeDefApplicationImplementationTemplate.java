...
public class AttributeDefApplicationImplementationTemplate
{
  ...
  protected final String TEXT_3 = "()" + NL + "        throws ccm.local.Components.CCMException" + NL + "    {" + NL + "        return this.";
  protected final String TEXT_4 = "_;" + NL + "    }     " + NL + "" + NL + "    public void ";
  protected final String TEXT_5 = "(";
  protected final String TEXT_6 = " value)" + NL + "        throws ccm.local.Components.CCMException" + NL + "    {" + NL + "        this.";
