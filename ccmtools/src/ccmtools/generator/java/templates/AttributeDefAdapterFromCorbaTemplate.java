...
public class AttributeDefAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_9 = "(valueLocal);" + NL + "            return value;" + NL + "        }" + NL + "        catch(java.lang.Exception e)" + NL + "        {" + NL + "    \t        throw new org.omg.CORBA.BAD_OPERATION(e.getMessage());" + NL + "        }" + NL + "    }" + NL + "     " + NL + "    public void ";
  ...
  protected final String TEXT_15 = "(valueLocal);" + NL + "        }" + NL + "        catch(java.lang.Exception e)" + NL + "        {" + NL + "    \t        throw new org.omg.CORBA.BAD_OPERATION(e.getMessage());" + NL + "        }" + NL + "    } ";
