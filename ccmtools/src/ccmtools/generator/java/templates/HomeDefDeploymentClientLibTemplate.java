...
public class HomeDefDeploymentClientLibTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "" + NL + "import Components.CCMException;" + NL + "import Components.CCMExceptionReason;" + NL + "import ccmtools.local.ServiceLocatorException;" + NL + "import ccmtools.local.ServiceLocator;    " + NL + "                              " + NL + "public class ";
  protected final String TEXT_4 = "ClientLibDeployment " + NL + "{" + NL + "   /** Default logger instance */" + NL + "    private static Logger logger = ServiceLocator.instance().getLogger();" + NL + "    " + NL + "    " + NL + "    public static void deploy(String name)" + NL + "        throws CCMException" + NL + "    {" + NL + "        logger.fine(\"name = \" + name);" + NL + "        try" + NL + "        {" + NL + "            ccmtools.corba.Components.CCMHome remoteHome = ServiceLocator.instance().findCCMHome(name);";
  protected final String TEXT_5 = NL + "            ";
  protected final String TEXT_6 = " localHome = new ";
  protected final String TEXT_7 = "AdapterToCorba(remoteHome);" + NL + "            Components.HomeFinder.instance().register_home(localHome, name);    " + NL + "        }" + NL + "        catch(ServiceLocatorException e)" + NL + "        {" + NL + "            throw new CCMException(e.getMessage(),CCMExceptionReason.SYSTEM_ERROR);" + NL + "        }" + NL + "    }" + NL + "" + NL + "    " + NL + "    public static void deployWithIor(String name, String ior)" + NL + "        throws CCMException" + NL + "    {" + NL + "        logger.fine(\"name = \" + name + \", ior = \" + ior);" + NL + "        org.omg.CORBA.Object obj = ServiceLocator.instance().getCorbaOrb().string_to_object(ior);" + NL + "        ccmtools.corba.Components.CCMHome remoteHome = " + NL + "            ccmtools.corba.Components.CCMHomeHelper.narrow(obj);";
