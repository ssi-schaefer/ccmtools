...
public class CcmComponentContextInterfaceTemplate
{
  protected static String nl;
  public static synchronized CcmComponentContextInterfaceTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    CcmComponentContextInterfaceTemplate result = new CcmComponentContextInterfaceTemplate();
    nl = null;
    return result;
  }
