...
public class OperationDefAdapterToCorbaTemplate
{
  ...
  protected final String TEXT_18 = NL + "        catch(java.lang.Exception e)" + NL + "        {" + NL + "    \t        throw new Components.CCMException(e.getMessage(), Components.CCMExceptionReason.SYSTEM_ERROR);" + NL + "        }" + NL + "    }";
