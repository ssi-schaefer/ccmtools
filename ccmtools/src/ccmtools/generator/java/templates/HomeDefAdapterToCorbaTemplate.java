...
public class HomeDefAdapterToCorbaTemplate
{
  ...
  protected final String TEXT_8 = "AdapterToCorba(String homeName)" + NL + "        throws ccm.local.Components.CCMException" + NL + "    {" + NL + "        logger.fine(\"homeName = \" + homeName);" + NL + "        this.homeName = homeName;" + NL + "    }" + NL + "    " + NL + "    " + NL + "    /** Home implicit operations */" + NL + "        " + NL + "    public ";
  ...
  protected final String TEXT_12 = "AdapterToCorba(remoteHome.create());        " + NL + "        }" + NL + "        catch(java.lang.Exception e)" + NL + "        {" + NL + "            throw new ccm.local.Components.CreateFailure();" + NL + "        }" + NL + "    } " + NL + "    " + NL + "    // This operation is defined in ccm.local.Components.KeylessCCMHomeOperations" + NL + "    public ccm.local.Components.CCMObject create_component()" + NL + "        throws ccm.local.Components.CCMException, ccm.local.Components.CreateFailure" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        return (ccm.local.Components.CCMObject)create();" + NL + "    }" + NL + "    " + NL + "    " + NL + "    /** Home explicit operations */" + NL + "        " + NL + "    // This operation is defined in ccm.local.Components.CCMHome" + NL + "    public void remove_component(ccm.local.Components.CCMObject component)" + NL + "        throws ccm.local.Components.CCMException, ccm.local.Components.RemoveFailure" + NL + "    {" + NL + "        logger.fine(\"component = \" + component);" + NL + "        throw new RuntimeException(\"Not Implemented\");" + NL + "    }" + NL + "}";
