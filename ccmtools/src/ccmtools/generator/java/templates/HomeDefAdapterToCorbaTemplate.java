...
public class HomeDefAdapterToCorbaTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "" + NL + "import Components.CCMException;" + NL + "import Components.CCMObject;" + NL + "import Components.CreateFailure;" + NL + "import Components.RemoveFailure;" + NL + "" + NL + "import ccmtools.local.ServiceLocator;" + NL + "           " + NL + "public class ";
  ...
  protected final String TEXT_7 = "AdapterToCorba(ccmtools.corba.Components.CCMHome ccmHome)" + NL + "        throws CCMException" + NL + "    {" + NL + "        logger.fine(\"ccmHome = \" + ccmHome);" + NL + "        remoteHome = ";
  ...
  protected final String TEXT_10 = "AdapterToCorba(remoteHome.create());        " + NL + "        }" + NL + "        catch(java.lang.Exception e)" + NL + "        {" + NL + "            throw new CreateFailure();" + NL + "        }" + NL + "    } " + NL + "    " + NL + "    // This operation is defined in Components.KeylessCCMHomeOperations" + NL + "    public CCMObject create_component()" + NL + "        throws CCMException, CreateFailure" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        return (CCMObject)create();" + NL + "    }" + NL + "    " + NL + "    " + NL + "    /** Home explicit operations */" + NL + "        " + NL + "    // This operation is defined in Components.CCMHome" + NL + "    public void remove_component(CCMObject component)" + NL + "        throws CCMException, RemoveFailure" + NL + "    {" + NL + "        logger.fine(\"component = \" + component);" + NL + "        if(component == null)" + NL + "        {" + NL + "            throw new RemoveFailure(\"Can't remove component because its reference is null!\");" + NL + "        }" + NL + "        else" + NL + "        {" + NL + "            component.remove();" + NL + "        } " + NL + "    }" + NL + "}";
