...
public class ComponentDefApplicationClassTemplate
{
  ...
  protected final String TEXT_22 = "    " + NL + "" + NL + "    /** Component callback methods */" + NL + "    " + NL + "    public void set_session_context(ccm.local.Components.SessionContext ctx) " + NL + "        throws ccm.local.Components.CCMException" + NL + "    {" + NL + "        this.ctx = (";
  protected final String TEXT_23 = "_Context)ctx; " + NL + "    }" + NL + "" + NL + "    public void ccm_activate() " + NL + "        throws ccm.local.Components.CCMException" + NL + "    {" + NL + "        // OPTIONAL: IMPLEMENT ME HERE !" + NL + "    }" + NL + "" + NL + "    public void ccm_passivate() " + NL + "        throws ccm.local.Components.CCMException" + NL + "    {" + NL + "        // OPTIONAL: IMPLEMENT ME HERE !" + NL + "    }" + NL + "" + NL + "    public void ccm_remove() " + NL + "        throws ccm.local.Components.CCMException" + NL + "    {" + NL + "        // OPTIONAL: IMPLEMENT ME HERE !" + NL + "    }" + NL + "}";
