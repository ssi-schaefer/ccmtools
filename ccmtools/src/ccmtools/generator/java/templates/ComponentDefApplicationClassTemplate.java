...
public class ComponentDefApplicationClassTemplate
{
  ...
  protected final String TEXT_6 = "  " + NL + "   " + NL + "/**" + NL + " * This class implements component equivalent and supported interfaces" + NL + " * as well as component attributes." + NL + " * Additionally, session component callback methods must be implemented." + NL + " *" + NL + " * // TODO: WRITE YOUR DESCRIPTION HERE !" + NL + " *" + NL + " * @author" + NL + " * @version" + NL + " */   " + NL + "public class ";
  ...
  protected final String TEXT_14 = "Impl()" + NL + "        throws Components.CCMException" + NL + "    {" + NL + "        // OPTIONAL: IMPLEMENT ME HERE !" + NL + "    }" + NL + "" + NL + "" + NL + "    /* " + NL + "     * Supported interface methods " + NL + "     */" + NL + "" + NL + "    /** Supported interface attributes */" + NL;
  protected final String TEXT_15 = NL;
  protected final String TEXT_16 = "    " + NL + "    " + NL + "    " + NL + "    /** Supported interface methods */" + NL + "    ";
  protected final String TEXT_17 = NL;
  protected final String TEXT_18 = "    " + NL + "" + NL + "" + NL + "    /** Component attribute accessor methods */" + NL;
  protected final String TEXT_19 = NL;
  protected final String TEXT_20 = "    " + NL + "" + NL + "" + NL + "    /** Facet implementation factory methods */" + NL + "    ";
  protected final String TEXT_21 = NL;
  protected final String TEXT_22 = "    " + NL + "" + NL + "    /** Component callback methods */" + NL + "    " + NL + "    public void set_session_context(Components.SessionContext ctx) " + NL + "        throws Components.CCMException" + NL + "    {" + NL + "        this.ctx = (";
  protected final String TEXT_23 = "_Context)ctx; " + NL + "    }" + NL + "" + NL + "    public void ccm_activate() " + NL + "        throws Components.CCMException" + NL + "    {" + NL + "        // OPTIONAL: IMPLEMENT ME HERE !" + NL + "    }" + NL + "" + NL + "    public void ccm_passivate() " + NL + "        throws Components.CCMException" + NL + "    {" + NL + "        // OPTIONAL: IMPLEMENT ME HERE !" + NL + "    }" + NL + "" + NL + "    public void ccm_remove() " + NL + "        throws Components.CCMException" + NL + "    {" + NL + "        // OPTIONAL: IMPLEMENT ME HERE !" + NL + "    }" + NL + "}";
