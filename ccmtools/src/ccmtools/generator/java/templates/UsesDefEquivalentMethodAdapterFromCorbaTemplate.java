...
public class UsesDefEquivalentMethodAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_17 = "Receptacle = null; " + NL + "            return result;" + NL + "        }" + NL + "        catch(ccm.local.Components.NoConnection e)" + NL + "        {" + NL + "            e.printStackTrace();" + NL + "            throw new Components.NoConnection(e.getMessage());" + NL + "        }" + NL + "    }" + NL + "     " + NL + "    public ";
