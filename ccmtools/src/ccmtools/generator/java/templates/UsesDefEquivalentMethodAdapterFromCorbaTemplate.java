...
public class UsesDefEquivalentMethodAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_3 = " obj)" + NL + "        throws ccmtools.corba.Components.AlreadyConnected, " + NL + "               ccmtools.corba.Components.InvalidConnection" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        try" + NL + "        {";
