...
public class ComponentDefAdapterToCorbaTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "import java.util.Map;" + NL + "import java.util.HashMap;" + NL + "" + NL + "import org.omg.PortableServer.POA;" + NL + "import org.omg.PortableServer.POAPackage.ServantNotActive;" + NL + "import org.omg.PortableServer.POAPackage.WrongPolicy;" + NL + "import org.omg.PortableServer.Servant;" + NL + "" + NL + "import Components.AlreadyConnected;" + NL + "import Components.CCMException;" + NL + "import Components.CCMExceptionReason;" + NL + "import Components.Cookie;" + NL + "import Components.CookieImpl;" + NL + "import Components.CookieRequired;" + NL + "import Components.ExceededConnectionLimit;" + NL + "import Components.CCMHome;" + NL + "import Components.InvalidName;" + NL + "import Components.InvalidConnection;" + NL + "import Components.InvalidConfiguration; " + NL + "import Components.NoConnection;" + NL + "import Components.RemoveFailure; " + NL + "" + NL + "import ccmtools.local.ServiceLocator;" + NL + "import ccmtools.local.ServiceLocatorException;" + NL;
