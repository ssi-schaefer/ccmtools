...
public class ComponentDefAdapterToCorbaTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "" + NL + "import ccm.local.Components.AlreadyConnected;" + NL + "import ccm.local.Components.CCMException;" + NL + "import ccm.local.Components.Cookie;" + NL + "import ccm.local.Components.CookieRequired;" + NL + "import ccm.local.Components.ExceededConnectionLimit;" + NL + "import ccm.local.Components.HomeExecutorBase;" + NL + "import ccm.local.Components.InvalidName;" + NL + "import ccm.local.Components.InvalidConnection;" + NL + "import ccm.local.Components.InvalidConfiguration; " + NL + "import ccm.local.Components.NoConnection;" + NL + "import ccm.local.Components.RemoveFailure; " + NL + "" + NL + "import ccm.local.ServiceLocator;" + NL + "import ccm.local.ServiceLocatorException;" + NL;
