...
public class HomeDefInterfaceTemplate
{
  protected static String nl;
  public static synchronized HomeDefInterfaceTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    HomeDefInterfaceTemplate result = new HomeDefInterfaceTemplate();
    nl = null;
    return result;
  }
