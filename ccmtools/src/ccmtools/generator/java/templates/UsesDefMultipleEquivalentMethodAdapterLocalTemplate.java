...
public class UsesDefMultipleEquivalentMethodAdapterLocalTemplate
{
  ...
  protected final String TEXT_3 = " obj)" + NL + "        throws ExceededConnectionLimit, " + NL + "               InvalidConnection" + NL + "    {" + NL + "        logger.fine(\"Object reference = \" + obj);" + NL + "        if(obj == null)" + NL + "        {" + NL + "            throw new InvalidConnection();" + NL + "        }\t" + NL + "        else" + NL + "        {" + NL + "            Cookie ck = new CookieImpl();            ";
  ...
  protected final String TEXT_7 = "(Cookie ck)" + NL + "        throws InvalidConnection" + NL + "    {" + NL + "\t    logger.fine(\"Cookie = \" + ck);        " + NL + "        if(ck == null || !";
  protected final String TEXT_8 = "ReceptacleMap.containsKey(ck))" + NL + "        {" + NL + "            throw new InvalidConnection();" + NL + "        }" + NL + "        else" + NL + "        {";
  protected final String TEXT_9 = NL + "            ";
  protected final String TEXT_10 = " f = ";
  protected final String TEXT_11 = "ReceptacleMap.get(ck);";
  protected final String TEXT_12 = NL + "            ";
  protected final String TEXT_13 = "ReceptacleMap.remove(ck);" + NL + "            return f;" + NL + "        }" + NL + "    }" + NL + "        " + NL + "    public java.util.Map<Cookie, ";
  protected final String TEXT_14 = "> get_connections_";
  protected final String TEXT_15 = "()" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        // return a copy of the receptacle map" + NL + "        return new java.util.HashMap<Cookie, ";
