...
public class UsesDefMultipleEquivalentMethodAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_6 = "AdapterToCorba(obj);" + NL + "                Components.Cookie lck = localInterface.connect_";
  ...
  protected final String TEXT_9 = "ReceptacleMap.put(ck, obj);" + NL + "                return ck;" + NL + "            }" + NL + "            catch(Components.ExceededConnectionLimit e)" + NL + "            {" + NL + "                throw new ccmtools.corba.Components.ExceededConnectionLimit(e.getMessage());" + NL + "            }" + NL + "            catch(Components.InvalidConnection e)" + NL + "            {" + NL + "                throw new ccmtools.corba.Components.InvalidConnection(e.getMessage());" + NL + "            }" + NL + "        }    " + NL + "    }" + NL + "" + NL + "    public ";
  protected final String TEXT_10 = " disconnect_";
  protected final String TEXT_11 = "(ccmtools.corba.Components.Cookie ck)" + NL + "        throws ccmtools.corba.Components.InvalidConnection" + NL + "    {" + NL + "        logger.fine(\"Cookie = \" + ck);" + NL + "" + NL + "        if(ck == null || !portReceptacleMap.containsKey(ck))" + NL + "        {" + NL + "            throw new ccmtools.corba.Components.InvalidConnection();" + NL + "        }" + NL + "        else" + NL + "        {" + NL + "            try" + NL + "            { " + NL + "                Components.Cookie lck = new Components.CookieImpl(ck.CookieValue);" + NL + "                localInterface.disconnect_port(lck);";
  protected final String TEXT_12 = NL + "                ";
  protected final String TEXT_13 = " f = ";
  protected final String TEXT_14 = "ReceptacleMap.get(ck);";
  protected final String TEXT_15 = NL + "                ";
  protected final String TEXT_16 = "ReceptacleMap.remove(ck);" + NL + "                return f;" + NL + "            }" + NL + "            catch(Components.InvalidConnection e)" + NL + "            {" + NL + "                throw new ccmtools.corba.Components.InvalidConnection(e.getMessage());" + NL + "            }" + NL + "        }    " + NL + "    }" + NL + "" + NL + "    public ";
