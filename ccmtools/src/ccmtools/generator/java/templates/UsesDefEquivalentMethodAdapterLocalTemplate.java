...
public class UsesDefEquivalentMethodAdapterLocalTemplate
{
  ...
  protected final String TEXT_3 = " localObj)" + NL + "        throws ccm.local.Components.AlreadyConnected, " + NL + "               ccm.local.Components.InvalidConnection" + NL + "    {" + NL + "        logger.fine(\"obj = \" + localObj);" + NL + "        if(";
  ...
  protected final String TEXT_8 = "()" + NL + "        throws ccm.local.Components.NoConnection" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        if(";
