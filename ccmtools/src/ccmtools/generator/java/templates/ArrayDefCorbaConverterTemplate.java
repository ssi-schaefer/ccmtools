...
public class ArrayDefCorbaConverterTemplate
{
  ...
  protected final String TEXT_6 = " in)" + NL + "       throws ccmtools.local.CorbaConverterException" + NL + "    {";
  ...
  protected final String TEXT_12 = " in)" + NL + "       throws ccmtools.local.CorbaConverterException" + NL + "    {";
