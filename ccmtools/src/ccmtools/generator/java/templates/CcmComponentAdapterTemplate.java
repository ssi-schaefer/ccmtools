...
public class CcmComponentAdapterTemplate
{
  ...
  protected final String TEXT_10 = "  " + NL + "\t" + NL + "    /** Receptacle references */";
  protected final String TEXT_11 = NL;
  protected final String TEXT_12 = "  " + NL + "\t\t" + NL + "    protected ";
  protected final String TEXT_13 = "Adapter()" + NL + "    {" + NL + "    }" + NL + "\t" + NL + "    public ";
  protected final String TEXT_14 = "Adapter(";
  protected final String TEXT_15 = " localInterface)" + NL + "    {" + NL + "        this.localInterface = localInterface;" + NL + "    }" + NL + "\t" + NL + "\t" + NL + "    /** Supported interface methods */ " + NL + "\t" + NL + "\t" + NL + "\t" + NL + "    /** " + NL + "     * Equivalent interface methods " + NL + "     */" + NL + "\t" + NL + "    /** Attribute equivalent methods */";
  protected final String TEXT_16 = NL;
  protected final String TEXT_17 = "    " + NL + "" + NL + "    /** Facet equivalent methods */    ";
  protected final String TEXT_18 = NL;
  protected final String TEXT_19 = "    " + NL + "    " + NL + "    /** Receptacle equivalent methods */";
  protected final String TEXT_20 = NL;
  protected final String TEXT_21 = NL + "\t" + NL + "    /** CCMObject interface methods */" + NL + "\t" + NL + "    public void configuration_complete()" + NL + "        throws ccm.local.Components.InvalidConfiguration" + NL + "    {" + NL + "        ctx = new ";
  protected final String TEXT_22 = "_ContextImpl(this); " + NL + "        try" + NL + "        {" + NL + "            localInterface.set_session_context(ctx);" + NL + "            localInterface.ccm_activate();" + NL + "        }" + NL + "        catch (ccm.local.Components.CCMException e)" + NL + "        {" + NL + "            throw new ccm.local.Components.InvalidConfiguration();" + NL + "        }" + NL + "    }" + NL + "" + NL + "    public void remove()" + NL + "        throws ccm.local.Components.RemoveFailure" + NL + "    { " + NL + "        try " + NL + "        {" + NL + "            localInterface.ccm_remove();" + NL + "        }" + NL + "        catch(ccm.local.Components.CCMException e)" + NL + "        {" + NL + "            throw new ccm.local.Components.RemoveFailure();" + NL + "        }" + NL + "    }" + NL + "    " + NL + "    public ccm.local.Components.HomeExecutorBase get_ccm_home()" + NL + "    {" + NL + "        throw new RuntimeException(\"Not implemented!\");" + NL + "    }" + NL + "    " + NL + "    " + NL + "    /** Navigation interface methods */" + NL + "    " + NL + "    public Object provide_facet(String name)" + NL + "        throws ccm.local.Components.InvalidName" + NL + "    {" + NL + "        if(name == null)" + NL + "        {" + NL + "            throw new ccm.local.Components.InvalidName();" + NL + "        }";
  protected final String TEXT_23 = NL;
  protected final String TEXT_24 = "   " + NL + "        throw new ccm.local.Components.InvalidName();" + NL + "    }" + NL + "    " + NL + "    " + NL + "    /** Receptacle methods */" + NL + "    " + NL + "    public ccm.local.Components.Cookie connect(String name, Object connection)" + NL + "        throws ccm.local.Components.InvalidName, " + NL + "               ccm.local.Components.InvalidConnection," + NL + "               ccm.local.Components.AlreadyConnected, " + NL + "               ccm.local.Components.ExceededConnectionLimit" + NL + "    {" + NL + "        throw new ccm.local.Components.InvalidName();" + NL + "    }" + NL + "    " + NL + "    public void disconnect(String name, ccm.local.Components.Cookie ck)" + NL + "        throws ccm.local.Components.InvalidName, " + NL + "               ccm.local.Components.InvalidConnection," + NL + "               ccm.local.Components.CookieRequired, " + NL + "               ccm.local.Components.NoConnection" + NL + "    {" + NL + "        throw new ccm.local.Components.InvalidName();" + NL + "    }    " + NL + "}";
