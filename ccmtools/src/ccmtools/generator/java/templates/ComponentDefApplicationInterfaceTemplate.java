...
public class ComponentDefApplicationInterfaceTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import Components.ccm.local.CCMException;     " + NL + "import Components.ccm.local.SessionComponent;" + NL;
  protected final String TEXT_4 = NL;
  protected final String TEXT_5 = "              " + NL + "              " + NL + "public interface ";
  protected final String TEXT_6 = " " + NL + "    extends SessionComponent";
