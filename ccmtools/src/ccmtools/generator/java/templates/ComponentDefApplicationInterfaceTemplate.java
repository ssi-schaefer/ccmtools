...
public class ComponentDefApplicationInterfaceTemplate
{
  ...
  protected final String TEXT_4 = " " + NL + "    extends ccm.local.Components.SessionComponent" + NL + "{" + NL + "" + NL + "    /** Component attribute accessor methods */" + NL + "    ";
  protected final String TEXT_5 = NL;
  protected final String TEXT_6 = "    " + NL + "" + NL + "" + NL + "    /** Facet implementation factory methods */" + NL;
