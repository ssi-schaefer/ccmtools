...
public class AttributeDefAdapterLocalTemplate
{
  ...
  protected final String TEXT_3 = "()" + NL + "        throws ccm.local.Components.CCMException" + NL + "    {";
  ...
  protected final String TEXT_8 = " value)" + NL + "        throws ccm.local.Components.CCMException" + NL + "    {" + NL + "        logger.fine(\"value = \" + value);" + NL + "        localInterface.";
