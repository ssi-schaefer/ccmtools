...
public class HomeDefDeploymentLocalTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "" + NL + "import Components.ccm.local.CCMHome;" + NL + "import Components.ccm.local.CCMException;" + NL + "import Components.ccm.local.AssemblyFactory;" + NL + "" + NL + "import ccm.local.HomeFinder;" + NL + "import ccm.local.ServiceLocator;" + NL + "" + NL + "" + NL + "public class ";
