...
public class AttributeDefAdapterToCorbaTemplate
{
  ...
  protected final String TEXT_3 = "()" + NL + "        throws ccm.local.Components.CCMException" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        try" + NL + "        {";
  ...
  protected final String TEXT_9 = "(valueRemote);" + NL + "            return value;" + NL + "        }" + NL + "        catch(java.lang.Exception e)" + NL + "        {" + NL + "    \t    throw new ccm.local.Components.CCMException(e.getMessage());" + NL + "        }" + NL + "    }" + NL + "     " + NL + "    public void ";
  protected final String TEXT_10 = "(";
  protected final String TEXT_11 = " value)" + NL + "        throws ccm.local.Components.CCMException" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        try" + NL + "        {";
  protected final String TEXT_12 = NL + "            ";
  protected final String TEXT_13 = " valueRemote;" + NL + "            valueRemote = ";
  protected final String TEXT_14 = "(value);" + NL + "            remoteInterface.";
  protected final String TEXT_15 = "(valueRemote);            " + NL + "        }" + NL + "        catch(java.lang.Exception e)" + NL + "        {" + NL + "    \t    throw new ccm.local.Components.CCMException(e.getMessage());" + NL + "        }" + NL + "    } ";
