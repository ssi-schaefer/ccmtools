...
public class HomeDefImplicitInterfaceTemplate
{
  ...
  protected final String TEXT_4 = "Implicit " + NL + "    extends Components.KeylessCCMHome" + NL + "{";
  protected final String TEXT_5 = NL + "    ";
  protected final String TEXT_6 = " create()" + NL + "        throws Components.CreateFailure;" + NL + "}";
