...
public class HomeDefAdapterFromCorbaTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "" + NL + "import java.util.logging.Logger;" + NL + "" + NL + "import ccmtools.local.ServiceLocator;" + NL + "import ccmtools.remote.CCMSessionContainer;" + NL + "" + NL + "import org.omg.PortableServer.Servant;" + NL;
