...
public class HomeDefAdapterLocalTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "   " + NL + "import java.util.logging.Logger;" + NL + "" + NL + "import ccm.local.Components.Assembly;" + NL + "import ccm.local.Components.AssemblyFactory;" + NL + "import ccm.local.Components.CCMException;" + NL + "import ccm.local.Components.CCMException;" + NL + "import ccm.local.Components.CCMObject;" + NL + "import ccm.local.Components.CreateFailure;" + NL + "import ccm.local.Components.RemoveFailure;" + NL + "import ccm.local.ServiceLocator;" + NL + "" + NL + "public class ";
  ...
  protected final String TEXT_19 = "Adapter(c);" + NL + "            }" + NL + "            return component;" + NL + "        }" + NL + "        catch(CCMException e)" + NL + "        {" + NL + "            throw new CreateFailure();" + NL + "        }    " + NL + "    }" + NL + "    " + NL + "    public void remove_component(CCMObject component) " + NL + "        throws CCMException, RemoveFailure" + NL + "    {" + NL + "        logger.fine(\"\");\t" + NL + "        component.remove();" + NL + "    }" + NL + "" + NL + "    public ccm.local.Components.CCMObject create_component() " + NL + "        throws CCMException, CreateFailure" + NL + "    {" + NL + "        logger.fine(\"\");" + NL + "        return create();" + NL + "    }" + NL + "}";
