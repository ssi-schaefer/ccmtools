...
public class HomeDefAdapterLocalTemplate
{
  ...
  protected final String TEXT_3 = ";" + NL + "   " + NL + "import java.util.logging.Logger;" + NL + "" + NL + "import Components.Assembly;" + NL + "import Components.AssemblyFactory;" + NL + "import Components.CCMException;" + NL + "import Components.CCMObject;" + NL + "import Components.CreateFailure;" + NL + "import Components.RemoveFailure;" + NL + "" + NL + "import ccmtools.local.ServiceLocator;" + NL + "" + NL + "public class ";
