...
public class ProvidesDef extends ModelElement implements JavaApplicationGeneratorElement
{
    ...
    {
        return TAB + "private " + getInterface().generateAbsoluteIdlName() + " " + getIdentifier()
                + "Facet;\n";
    }
