...
public class Idl2StructDefFileTemplate
{
  protected static String nl;
  public static synchronized Idl2StructDefFileTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    Idl2StructDefFileTemplate result = new Idl2StructDefFileTemplate();
    nl = null;
    return result;
  }
