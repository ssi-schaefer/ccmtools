...
public class TypedefDefFileTemplate
{
  protected static String nl;
  public static synchronized TypedefDefFileTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    TypedefDefFileTemplate result = new TypedefDefFileTemplate();
    nl = null;
    return result;
  }
