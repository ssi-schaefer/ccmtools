...
public class EnumDefFileTemplate
{
  protected static String nl;
  public static synchronized EnumDefFileTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    EnumDefFileTemplate result = new EnumDefFileTemplate();
    nl = null;
    return result;
  }
