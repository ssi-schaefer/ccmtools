...
public class ComponentDefTemplate
{
  protected static String nl;
  public static synchronized ComponentDefTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    ComponentDefTemplate result = new ComponentDefTemplate();
    nl = null;
    return result;
  }
  ...
  public String generate(Object argument)
  {
    ...
    stringBuffer.append(model.generateProvidedInterfaces());
    stringBuffer.append(TEXT_18);
    stringBuffer.append(model.generateUsedInterfaces());
