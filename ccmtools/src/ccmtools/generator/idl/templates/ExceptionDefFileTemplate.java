...
public class ExceptionDefFileTemplate
{
  protected static String nl;
  public static synchronized ExceptionDefFileTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    ExceptionDefFileTemplate result = new ExceptionDefFileTemplate();
    nl = null;
    return result;
  }
