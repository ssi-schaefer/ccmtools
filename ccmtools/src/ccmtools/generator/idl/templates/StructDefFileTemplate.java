...
public class StructDefFileTemplate
{
  protected static String nl;
  public static synchronized StructDefFileTemplate create(String lineSeparator)
  {
    nl = lineSeparator;
    StructDefFileTemplate result = new StructDefFileTemplate();
    nl = null;
    return result;
  }
