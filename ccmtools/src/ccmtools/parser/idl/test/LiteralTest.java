...
//       }
    ...
    public void testStringConcatLiteral()
        throws CcmtoolsException
    {       
        MConstantDef constant = parseSource("const string STRING_LITERAL = \"Hello\" \" World\";");                
        String constValue = (String)constant.getConstValue();            
    ...
    public void testBoundedStringLiteralError() throws CcmtoolsException
    {
        try
        {
            MConstantDef constant = parseSource("const string<7> STRING_LITERAL = \"01234567\";");
            fail();
        }
        catch (Exception e)
        {
    ...
    public void testWideStringConcatLiteral()
        throws CcmtoolsException
    {       
    ...
    public void testBoundedWideStringLiteral() 
        throws CcmtoolsException
    {
        ...
        throws CcmtoolsException
    {
        try
        {
            MConstantDef constant = parseSource("const wstring<7> STRING_LITERAL = L\"01234567\";");
            fail();
        }
        catch (Exception e)
        {
