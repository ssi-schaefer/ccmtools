...
%JAVA_HOME%\bin\java -cp %CLASSPATH% -Dccmtools.home=%CCMTOOLS_HOME% -Djava.util.logging.config.file=%CCMTOOLS_HOME%\etc\logging.properties ccmtools.generator.java.Main %*
