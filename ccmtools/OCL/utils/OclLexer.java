...
public class OclLexer extends antlr.CharScanner implements OCLTokenTypes, TokenStream
 {
...
public OclLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("let", this), new Integer(15));
	literals.put(new ANTLRHashString("pre", this), new Integer(20));
	literals.put(new ANTLRHashString("if", this), new Integer(29));
	literals.put(new ANTLRHashString("inv", this), new Integer(37));
	literals.put(new ANTLRHashString("endpackage", this), new Integer(5));
	literals.put(new ANTLRHashString("endif", this), new Integer(32));
	literals.put(new ANTLRHashString("def", this), new Integer(6));
	literals.put(new ANTLRHashString("then", this), new Integer(30));
	literals.put(new ANTLRHashString("xor", this), new Integer(54));
	literals.put(new ANTLRHashString("or", this), new Integer(53));
	literals.put(new ANTLRHashString("in", this), new Integer(14));
	literals.put(new ANTLRHashString("Bag", this), new Integer(39));
	literals.put(new ANTLRHashString("else", this), new Integer(31));
	literals.put(new ANTLRHashString("Collection", this), new Integer(41));
	literals.put(new ANTLRHashString("true", this), new Integer(27));
	literals.put(new ANTLRHashString("Sequence", this), new Integer(40));
	literals.put(new ANTLRHashString("implies", this), new Integer(51));
	...
	literals.put(new ANTLRHashString("context", this), new Integer(9));
	literals.put(new ANTLRHashString("post", this), new Integer(36));
}
...
tryAgain:
		...
		do {
			...
			case '\\':
			{
				...
				case '0':  case '1':  case '2':  case '3':
				{
					...
					{
					if (((LA(1) >= '0' && LA(1) <= '7')) && (_tokenSet_1.member(LA(2)))) {
						{
						matchRange('0','7');
						}
						{
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { 9223370993177723392L, 4611686012790243327L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_0 = new BitSet(mk_tokenSet_0());
	private static final long[] mk_tokenSet_1() {
		long[] data = { 9223371542933537280L, 4611686013058678783L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_1 = new BitSet(mk_tokenSet_1());
	private static final long[] mk_tokenSet_2() {
		long[] data = { 9223371542933545472L, 4611686013058678783L, 0L, 0L};
		return data;
	}
