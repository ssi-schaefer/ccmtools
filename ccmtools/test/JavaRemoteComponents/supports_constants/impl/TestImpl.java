    ...
    implements CCM_Test
{
    ...
    public boolean getBooleanValue() throws CCMException
    {
        return Constants.BOOLEAN_CONST;
    }

    public byte getOctetValue() throws CCMException
    {
        return Constants.OCTET_CONST;
    }

    public short getShortValue() throws CCMException
    {
        return Constants.SHORT_CONST;
    }

    public short getUnsignedShortValue() throws CCMException
    {
        return Constants.USHORT_CONST;
    }

    public int getLongValue() throws CCMException
    {
        return Constants.LONG_CONST;
    }

    public int getUnsignedLongValue() throws CCMException
    {
        return Constants.ULONG_CONST;
    }

    public char getCharValue() throws CCMException
    {
        return Constants.CHAR_CONST;
    }

    public String getStringValue() throws CCMException
    {
        return Constants.STRING_CONST;
    }

    public float getFloatValue() throws CCMException
    {
        return Constants.FLOAT_CONST;
    }

    public double getDoubleValue() throws CCMException
    {
