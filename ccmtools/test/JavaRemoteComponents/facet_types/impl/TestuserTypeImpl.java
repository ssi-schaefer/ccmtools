	...
	implements CCM_UserTypeInterface
{
	...
	public TestuserTypeImpl(world.europe.austria.TestImpl component)
	{
	...
	public int[] f8(int[] p1, Holder<int[]> p2, Holder<int[]> p3) throws CCMException
	{
	...
	public String[] f9(String[] p1, Holder<String[]> p2, Holder<String[]> p3) throws CCMException
	{
		int length = 10; // For this test, we assume that all arrays are of
							// the same size
	...
	public Person[] f10(Person[] p1, Holder<Person[]> p2, Holder<Person[]> p3) throws CCMException
	{
		int length = 10; // For this test, we assume that all arrays are of
							// the same size
	...
	public int[][] f11(int[][] p1, Holder<int[][]> p2, Holder<int[][]> p3) throws CCMException
	{
		// TODO: implement test case
		return null;
	}

	public int[][][] f12(int[][][] p1, Holder<int[][][]> p2, Holder<int[][][]> p3)
		throws CCMException
	{
		// TODO: implement test case
		return null;
