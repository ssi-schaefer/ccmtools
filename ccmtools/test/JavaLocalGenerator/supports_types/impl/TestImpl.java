    ...
    implements CCM_Test
{
    ...
    public int[] fu8(int[] p1, ccm.local.Holder<int[]> p2, ccm.local.Holder<int[]> p3)
        throws ccm.local.Components.CCMException
    {
    ...
    public String[] fu9(String[] p1, ccm.local.Holder<String[]> p2, ccm.local.Holder<String[]> p3)
        throws ccm.local.Components.CCMException
    {
        int length = 10; 
	// For this test, we assume that all arrays are of the same size
    ...
    public Person[] fu10(Person[] p1, ccm.local.Holder<Person[]> p2, ccm.local.Holder<Person[]> p3)
        throws ccm.local.Components.CCMException
    {
        int length = 10; 
	// For this test, we assume that all arrays are of the same size
