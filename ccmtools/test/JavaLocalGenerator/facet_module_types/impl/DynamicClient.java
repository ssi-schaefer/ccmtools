	...
	public static void main(String[] args)
	{
		...
		try
		{
			...
			VoidTypeInterface voidType = 
			    (VoidTypeInterface)component.provide_facet("voidType");
			{
				voidType.f1(7);
			...
			BasicTypeInterface basicType = 
			    (BasicTypeInterface)component.provide_facet("basicType");
			{ // short
				short p1 = 7;
			...
			UserTypeInterface userType = 
			    (UserTypeInterface)component.provide_facet("userType");
