...
public class C3Adapter 
    implements C3
{
    private Logger logger = ServiceLocator.instance().getLogger();
    
    private CCM_C3 localInterface;
    private CCM_C3_Context ctx;
    ...
    public C3Adapter(CCM_C3 localInterface)
    {
        this(localInterface, null);
    }
	
    public C3Adapter(CCM_C3 localInterface, Assembly assembly)
    {
    ...
    {
        logger.fine("");
        ctx = new CCM_C3_ContextImpl(this); 
        try
        {
            if(assembly != null) 
            { 
