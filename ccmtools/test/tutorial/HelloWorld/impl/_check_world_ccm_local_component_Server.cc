...
int main(int argc, char *argv[])
{
    ...
    SmartPtr< world::ccm::local::component::Server::Server> myServer;

    SmartPtr< world::ccm::local::Hello> hello;
    ...
    // callback methods.
    try {
        SmartPtr< world::ccm::local::component::Server::ServerHome> myServerHome(
            dynamic_cast< world::ccm::local::component::Server::ServerHome*>
            (homeFinder->find_home_by_name("ServerHome").ptr()));

        myServer = myServerHome->create();
 
        hello = myServer->provide_hello();

        myServer->configuration_complete();
    } 
