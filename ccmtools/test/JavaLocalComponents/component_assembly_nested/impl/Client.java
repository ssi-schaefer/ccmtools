...
public class Client
{
    public static void main(String[] args)
    {
        ...
        try
        {
            SuperTestHomeDeployment.deploy("SuperTestHome", new AssemblyFactoryTemplate(world.Assembly.class));
        ...
        try
        {
            SuperTestHome home = (SuperTestHome) HomeFinder.instance().find_home_by_name("SuperTestHome");
