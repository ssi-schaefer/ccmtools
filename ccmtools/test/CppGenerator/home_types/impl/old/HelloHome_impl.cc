...
HelloHome_impl::create (  )
  throw ( LocalComponents::CCMException )
{
  return dynamic_cast<LocalComponents::EnterpriseComponent*>(new Hello_impl (  ));
}

/* basic type factories. */

LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_short ( const short id )
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_long ( const long id )
  throw ( LocalComponents::CCMException,LocalComponents::CreateFailure )
{
  CCM_Hello_impl* lc = new CCM_Hello_impl();
  lc->long_value(id);
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_ushort ( const unsigned short id )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_ulong ( const unsigned long id )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_float ( const float id )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_double ( const double id )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_char ( const char id )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_string ( const std::string& id )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_boolean ( const bool id )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_octet ( const unsigned char id )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_typedef ( const time_t& p )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_enum ( const Color& p )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_struct ( const Value& p )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_sequence ( const map& p )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
LocalComponents::EnterpriseComponent*
HelloHome_impl::create_with_array ( const doubleArray& p )
  throw (LocalComponents::CCMException, LocalComponents::CreateFailure )
{
...
extern "C" {
  ...
  create_HelloHome (  )
  {
    ...
    return new CCM_Local::CCM_Session_Hello::HelloHome_impl (  );
  }
}
