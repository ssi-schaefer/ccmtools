...
//==============================================================================
// CCM_TypeTest facet implementation
//==============================================================================

CCM_TypeTest*
CCM_Test_mirror_impl::get_type_test_mirror (  )
{
  DEBUGNL ( " CCM_Test_mirror_impl->get_type_test_mirror (  )" );
  type_test_mirror_impl* facet = new type_test_mirror_impl(this);
  return dynamic_cast<CCM_TypeTest*> ( facet );
}
...
type_test_mirror_impl::op_i1 ( const WX::Utils::SmartPtr<Console>& p1, 
		     WX::Utils::SmartPtr<Console>& p2, WX::Utils::SmartPtr<Console>& p3 )
  throw (LocalComponents::CCMException)
{
