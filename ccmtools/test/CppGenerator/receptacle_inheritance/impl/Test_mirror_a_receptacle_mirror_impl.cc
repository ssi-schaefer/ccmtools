...
const long
a_receptacle_mirror_impl::attr3() const
...
void
a_receptacle_mirror_impl::attr3(const long value)
    throw(::ccm::local::Components::CCMException)
{
    attr3_ = value;
}
...
const long
a_receptacle_mirror_impl::attr2() const
    throw(::ccm::local::Components::CCMException)
{
    return attr2_;
}
...
void
a_receptacle_mirror_impl::attr2(const long value)
    throw(::ccm::local::Components::CCMException)
{
    attr2_ = value;
}
...
const long
a_receptacle_mirror_impl::attr1() const
    throw(::ccm::local::Components::CCMException)
{
    return attr1_;
}
...
void
a_receptacle_mirror_impl::attr1(const long value)
    throw(::ccm::local::Components::CCMException)
{
    attr1_ = value;
}
