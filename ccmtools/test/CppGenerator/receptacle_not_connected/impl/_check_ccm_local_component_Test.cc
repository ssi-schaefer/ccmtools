...
#include <ccm/local/component/TestMirror/TestHomeMirror_gen.h>
...
int main(int argc, char *argv[])
{
    ...
    try {
	  ...
	  myTestHome(dynamic_cast<component::Test::TestHome*>
        ...
        SmartPtr<component::TestMirror::TestHomeMirror> 
            myTestHomeMirror(
            dynamic_cast<component::TestMirror::TestHomeMirror*>
        ...
        Test_uses_console = 
            myTestMirror->provide_facet("console");
    ...
    error += undeploy_ccm_local_component_TestMirror_TestHomeMirror("TestHomeMirror");
    if(error) {
