...
#include <ccm/local/TestMirror_gen.h>
#include <ccm/local/TestHomeMirror_gen.h>
...
int main(int argc, char *argv[])
{
    ...
    error += deploy_ccm_local_TestHomeMirror("TestHomeMirror");	
    if(error) {
    ...
    error += undeploy_ccm_local_TestHomeMirror("TestHomeMirror");
    if(error) {
