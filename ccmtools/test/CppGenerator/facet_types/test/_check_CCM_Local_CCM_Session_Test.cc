...
int main(int argc, char *argv[])
{
  ...
  SmartPtr<CCM_Local::TypeTest> Test_provides_type_test;
  ...
  try {
    ...
    Test_provides_type_test =  myTest->provide_type_test();
    myTestMirror->connect_type_test_mirror(Test_provides_type_test);
  ...
  try {
    myTestMirror->disconnect_type_test_mirror();
