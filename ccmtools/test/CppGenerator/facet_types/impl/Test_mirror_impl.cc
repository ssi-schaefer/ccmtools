  ...
  throw ( LocalComponents::CCMException )
{
...

  {
    ...
    cout << CCM_Local::ccmDebug(short_r,2) << endl; //!!!
    assert(short_2 == 7);
    assert(short_3 == 3);
    assert(short_r == 3+7);
    ...
    cout << CCM_Local::ccmDebug(long_r,2) << endl; //!!!
    assert(long_2 == 7);
    assert(long_3 == 3);
    assert(long_r == 3+7);
    ...
    cout << CCM_Local::ccmDebug(ushort_r,2) << endl; //!!!
    assert(ushort_2 == 7);
    assert(ushort_3 == 3);
    assert(ushort_r == 3+7);
    ...
    cout << CCM_Local::ccmDebug(ulong_r,2) << endl; //!!!
    assert(ulong_2 == 7);
    assert(ulong_3 == 3);
    assert(ulong_r == 3+7);
    ...
    cout << CCM_Local::ccmDebug(float_r,2) << endl; //!!!
    assert(float_2 == 7.0);
    assert(float_3 == 3.0);
    ...
    cout << CCM_Local::ccmDebug(double_r,2) << endl; //!!!
    assert(double_2 == 7.0);
    assert(double_3 == 3.0);
    ...
    cout << CCM_Local::ccmDebug(char_r,2) << endl; //!!!
    assert(char_2 == 7);
    assert(char_3 == 3);
    assert(char_r == 3+7);
    ...
    cout << CCM_Local::ccmDebug(string_r,2) << endl; //!!!
    ...
    cout << CCM_Local::ccmDebug(bool_r,2) << endl; //!!!
    assert(bool_2 == true);
    assert(bool_3 == false);
    ...
    cout << CCM_Local::ccmDebug(uchar_r,2) << endl; //!!!
    assert(uchar_2 == 7);
    assert(uchar_3 == 3);
    assert(uchar_r == 3+7);
  }
...

  {
    ...
    cout << CCM_Local::ccmDebug(time_t_r,2) << endl; //!!!
    assert(time_t_2 == 7);
    assert(time_t_3 == 3);
    assert(time_t_r == 3+7);
    ...
    cout << CCM_Local::ccmDebug(Color_3,2) << endl; //!!!
    ...
    cout << CCM_Local::ccmDebug(Pair_r,2) << endl; //!!!
    assert(Pair_3.key == "b");
    assert(Pair_2.key == "a");
    ...
    cout << CCM_Local::ccmDebug(map_r,2) << endl; //!!!
    ...
    cout << CCM_Local::ccmDebug(Array_r,2) << endl; //!!!
    for(int i=0;i<10;i++) {
