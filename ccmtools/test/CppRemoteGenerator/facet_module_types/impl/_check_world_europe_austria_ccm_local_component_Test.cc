...
#include <world/europe/austria/ccm/local/component/Test/Test_gen.h>
#include <world/europe/austria/ccm/local/component/Test/TestHome_gen.h>

using namespace std;
using namespace WX::Utils;
using namespace ccm::local;

using world::europe::austria::ccm::local::component::Test::Test;
using world::europe::austria::ccm::local::component::Test::TestHome;
using world::europe::austria::ccm::local::BasicTypeInterface;
using world::europe::austria::ccm::local::UserTypeInterface;
using world::europe::austria::ccm::local::VoidTypeInterface;

using world::europe::austria::ccm::local::Color;
using world::europe::austria::ccm::local::Person;
using world::europe::austria::ccm::local::Address;
using world::europe::austria::ccm::local::LongList;
using world::europe::austria::ccm::local::StringList;
using world::europe::austria::ccm::local::PersonList;
using world::europe::austria::ccm::local::time_t;
...
int main(int argc, char *argv[])
{
    ...
    error += undeploy_world_europe_austria_ccm_local_component_Test_TestHome("TestHome");
    if(error) {
