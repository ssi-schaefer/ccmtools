    ...
    throw(Components::CCMException)
{
  ...
  // ------------------------------------------------------------------
  {
    ...
    CCM_VoidTypeInterface::SmartPtr out = ctx->get_connection_outVoidType();
  ...
  // ------------------------------------------------------------------
  {
    ...
    CCM_BasicTypeInterface::SmartPtr out = ctx->get_connection_outBasicType();
    {
  ...
  // ------------------------------------------------------------------
  {
    ...
    CCM_UserTypeInterface::SmartPtr out = ctx->get_connection_outUserType();
