...
main (int argc, char *argv[])
{
    ...
    // Provide facets   
    ::CORBA_Stubs::IFace_var IFaceinPort = 
        myTest->provide_inPort();

    myTest->connect_outPort(IFaceinPort);
    ...
    short_r = IFaceinPort->op1(7,short_2, short_3);
    assert(short_2 == 7);
    assert(short_3 == 3);
    assert(short_r == 3+7);
    
    CORBA::Long long_2=3, long_3, long_r;
    long_r = IFaceinPort->op2(7,long_2, long_3);
    assert(long_2 == 7);
    assert(long_3 == 3);
    assert(long_r == 3+7);
    
    CORBA::UShort ushort_2=3, ushort_3, ushort_r;
    ushort_r = IFaceinPort->op3(7,ushort_2, ushort_3);
    assert(ushort_2 == 7);
    assert(ushort_3 == 3);
    assert(ushort_r == 3+7);
    
    CORBA::ULong ulong_2=3, ulong_3, ulong_r;
    ulong_r = IFaceinPort->op4(7,ulong_2, ulong_3);
    assert(ulong_2 == 7);
    assert(ulong_3 == 3);
    assert(ulong_r == 3+7);

    CORBA::Float float_2=3.0, float_3, float_r;
    float_r = IFaceinPort->op5(7.0,float_2, float_3);
    assert(float_2 == 7.0);
    assert(float_3 == 3.0);
    assert(float_r == 3.0+7.0);
     
    CORBA::Double double_2=3.0, double_3, double_r;
    double_r = IFaceinPort->op6(7.0,double_2, double_3);
    assert(double_2 == 7.0);
    assert(double_3 == 3.0);
    assert(double_r == 3.0+7.0);

    CORBA::Char char_2=3, char_3, char_r;
    char_r = IFaceinPort->op7(7,char_2, char_3);
    assert(char_2 == 7);
    assert(char_3 == 3);
    assert(char_r == 3+7);
    ...
    char* string_3;
    char* string_r;
    string_r = IFaceinPort->op8("sieben",string_2, string_3);
    ...
    bool_r = IFaceinPort->op9(true, bool_2, bool_3);
    assert(bool_2 == true);
    assert(bool_3 == false);
    assert(bool_r == false && true);
    
    CORBA::Octet octet_2=3, octet_3, octet_r;
    octet_r = IFaceinPort->op10(7,octet_2, octet_3);
    assert(octet_2 == 7);
    assert(octet_3 == 3);
    assert(octet_r == 3+7);
