...
main (int argc, char *argv[])
{
    ...
    char* string_3;
    char* string_r;
    string_r = myTest->op8("sieben",string_2, string_3);
    ...
    bool_r = myTest->op9(true, bool_2, bool_3);
    assert(bool_2 == true);
    assert(bool_3 == false);
    assert(bool_r == false && true);
    
    CORBA::Octet octet_2=3, octet_3, octet_r;
    octet_r = myTest->op10(7,octet_2, octet_3);
    assert(octet_2 == 7);
    assert(octet_3 == 3);
    assert(octet_r == 3+7);
