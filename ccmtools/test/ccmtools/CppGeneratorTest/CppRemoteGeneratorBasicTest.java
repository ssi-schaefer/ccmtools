 ...
 ***/
public class CppRemoteGeneratorBasicTest extends CcmtoolsTestCase
{
    private String ccmtoolsDir;

    public CppRemoteGeneratorBasicTest(String name)
    {
	super(name);
	...
	try {
	    runDefaultCcmtoolsGenerate(testDir, sandboxDir);
	    copyFile(testDir + "/impl/Test_iface_impl.cc", 
		     sandboxDir + "/impl/Test_iface_impl.cc");
	    copyFile(testDir + "/test/_check_CCM_Remote_CCM_Session_Test_remote.cc", 
		     sandboxDir + "/test/_check_CCM_Remote_CCM_Session_Test_remote.cc");
	    runDefaultConfix(sandboxDir);
	}
	...
	try {
	    ...
	    copyFile(testDir + "/impl/Test_impl.cc", 
		     sandboxDir + "/impl/Test_impl.cc");
	    copyFile(testDir + "/impl/Test_inPort_impl.cc", 
		     sandboxDir + "/impl/Test_inPort_impl.cc");
	    copyFile(testDir + "/test/_check_CCM_Remote_CCM_Session_Test_remote.cc", 
		     sandboxDir + "/test/_check_CCM_Remote_CCM_Session_Test_remote.cc");
	    runDefaultConfix(sandboxDir);
	}
