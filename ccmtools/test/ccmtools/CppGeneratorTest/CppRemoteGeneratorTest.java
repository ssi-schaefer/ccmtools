...
public class CppRemoteGeneratorTest extends CcmtoolsTestCase
{
	...
	try {
	    runDefaultCcmtoolsGenerate(testDir, sandboxDir);
	    copyFile(testDir + "/impl/Test_impl.cc", 
		     sandboxDir + "/impl/Test_impl.cc");
	    copyFile(testDir + "/test/_check_CCM_Remote_CCM_Session_Test_remote.cc", 
		     sandboxDir + "/test/_check_CCM_Remote_CCM_Session_Test_remote.cc");
	    runDefaultConfix(sandboxDir);
	}
    ...
    {
	String testDir = ccmtoolsDir + 
	    "/test/CppRemoteGenerator/facet_simple";
	String sandboxDir = ccmtoolsDir + 
	    "/test/CppRemoteGenerator/sandbox/facet_simple";

	try {
	    runDefaultCcmtoolsGenerate(testDir, sandboxDir);
	    copyFile(testDir + "/impl/Test_my_facet_impl.cc", 
		     sandboxDir + "/impl/Test_my_facet_impl.cc");
	    copyFile(testDir + "/test/_check_CCM_Remote_CCM_Session_Test_remote.cc", 
		     sandboxDir + "/test/_check_CCM_Remote_CCM_Session_Test_remote.cc");
	    runDefaultConfix(sandboxDir);
	}
	...
	try {
	    ...
	    copyFile(testDir + "/impl/Test_my_facet_impl.cc", 
		     sandboxDir + "/impl/Test_my_facet_impl.cc");
	    copyFile(testDir + "/test/_check_CCM_Remote_world_CCM_Session_Test_remote.cc", 
		     sandboxDir + "/test/_check_CCM_Remote_world_CCM_Session_Test_remote.cc");
	    runDefaultConfix(sandboxDir);
	}
	catch(Exception e) {
	    fail();
	...
	try {
	    runDefaultCcmtoolsGenerate(testDir, sandboxDir);
	    copyFile(testDir + "/impl/Test_in_port_impl.cc", 
		     sandboxDir + "/impl/Test_in_port_impl.cc");
	    copyFile(testDir + "/impl/Test_impl.cc", 
		     sandboxDir + "/impl/Test_impl.cc");
	    copyFile(testDir + "/test/_check_CCM_Remote_CCM_Session_Test_remote.cc", 
		     sandboxDir + "/test/_check_CCM_Remote_CCM_Session_Test_remote.cc");
