 ...
 * These tests only check the code generation process, while the runtime behavior 
 * of the generated coed is checked by Confix' _check_* files.  
 *
...
public class CcmtoolsTestCase extends TestCase
{
     ...
     * main function. 
     *
     * @param Commandline parameters are collected in a List of String.
     **/
     ...
     * main function. 
     *
     * @param Commandline parameters are collected in a single String
    ...
    /**
     * Create an empty Makefile.py file within the given package directory.
     * This file is needed by Confix to detect package directories. 
     *
     * @param Path to the Confix package directory in which the Makefile.py
     *        should be put.
     **/
	...
	try {
	    ...
	    out.close();
	    System.out.println(">>> create " + package_root + File.separator + "Makefile.py");
	}
	catch(Exception e) {
     ...
     * This method is used to copy impl and test files into the generated 
     * directories to check a component's runtime behavior.
     *
     **/
	...
	try {
	    ...
	    Process proc = Runtime.getRuntime().exec("confix.py " + args);

           // copy input and error to the output stream
            StreamPumper inputPumper =
                new StreamPumper(proc.getInputStream());
            StreamPumper errorPumper =
                new StreamPumper(proc.getErrorStream());
