...
#include <CCM_Local/CCM_Session_Math/Math_gen.h>
#include <CCM_Local/CCM_Session_Math/MathHome_gen.h>
...
int main ( int argc, char *argv[] )
{
  ...
  error  = local_deploy_MathHome("MathHome");
  ...
  try {
    ...
    cout << endl << "performance test with local component" << endl << endl;
