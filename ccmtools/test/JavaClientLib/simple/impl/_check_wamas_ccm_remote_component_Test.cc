...
#include <wamas/ccm/remote/component/Test/TestHome_remote.h>
#include <wamas_Test.h>
...
int main (int argc, char *argv[])
{
    ...
    int error = 0;
    error += deploy_wamas_ccm_local_component_Test_TestHome("TestHome");
    error += deploy_wamas_ccm_remote_component_Test_TestHome(orb, "TestHome:1.0");
    if(!error) {
