...
public class Client
{
	...
	try
	{
		...
		world.europe.austria.Person egon = 
		    new world.europe.austria.Person(3, "Egon");
		world.europe.austria.Address p1 = 
		    new world.europe.austria.Address("Waltendorf", 7, egon);
		...
		world.europe.austria.Person[] p1 = 
		    new world.europe.austria.Person[5];
		world.europe.austria.Person[] p2Value = 
		    new world.europe.austria.Person[5];
		for(int i = 0; i< 5; i++)
		{
		    world.europe.austria.Person p = 
		    p1[i] = new world.europe.austria.Person(i,"Andrea");
		    p2Value[i] = new world.europe.austria.Person(i+i,"Egon");
		}
		world.europe.austria.PersonListHolder p2 = 
		    new world.europe.austria.PersonListHolder(p2Value);
		world.europe.austria.PersonListHolder p3 =
		    new world.europe.austria.PersonListHolder();
