...
public class DtdGenerator
{
    ...
    "'dtd2java' is part of the \"CCM tools\" project (http://ccmtools.sourceforge.net).\n\n"+
    "DO NOT EDIT!\n\n\n"+
    GPL_TEXT+
    "\n*/\n\n\n";
     ...
     */
	public void run( DtdFile dtd, String javaPackage ) throws IOException
	{
        ...
        for( index=0; index<size; index++ )
        {
            ...
            w.write( c.createCode(javaPackage_) );
	...
	private void createPackage() throws IOException
	{
        ...
        baseDirectory_ = new File(dirName);
        ...
        */
        ...
        w6.write("<body>\n"+
                 ...
                 "<a href=\"http://ccmtools.sourceforge.net\">CCM tools</a>"+
                 " project.<p>\n"+
                 "<pre>\n"+
                 GPL_TEXT+
                 "</pre>\n"+
	...
	DtdClass createClass( String eName )
	{
        ...
        theClass = new DtdClass(eName, javaPackage_, element, attributes);
