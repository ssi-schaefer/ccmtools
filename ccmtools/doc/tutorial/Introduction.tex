...
of the current release series (CCM Tools release series 0.3.3).
...
\item [Remote C++ Component Generator]
...
\item [Remote C++ Test Generator]
After generation of remote components there is also a need for a remote test
client. This generated test client uses CORBA to connect to the remote components
and to call their operations.
