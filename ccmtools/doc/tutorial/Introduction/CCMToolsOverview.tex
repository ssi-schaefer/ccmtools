...
Due to the fact that the CCM Tools have been developed as a research project,
...
business logic.
%In a software system, components are always connected via
