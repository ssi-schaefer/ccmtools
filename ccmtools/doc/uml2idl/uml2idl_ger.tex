...
\item Die zusätzlichen \emph{stereotypes} und \emph{tagged values}
    für CORBA und CCM müssen die UML-Basisklasse \texttt{ModelElement} haben,
    wenn sie in mehr als einem UML-Element benötigt werden.
\end{itemize}
